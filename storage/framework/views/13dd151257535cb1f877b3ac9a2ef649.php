						...
						<div class="box-body" style="min-height:200px;overflow-x:scroll;">
									...
									<?php $no=0;?>
										...
										<tr>
											...
											<td>
												...
												<div class="pull-right">
													<?php if(request()->user()->hasRole('root')||request()->user()->hasRole('hr_access')): ?>
														<button title="Delete" type="button" class="delete-modal btn btn-danger btn-xs" data-delid="<?php echo e($dt->id); ?>" data-delname="<?php echo e($dt->employee_name); ?> for <?php echo e($dt->apply_date); ?>"><i class="fa fa-trash"></i></button>
													<?php endif; ?>
							...
							<div id="tabel3">
								<table id="table3" class="table table-striped" border="0">
									...
									<tbody>
									<?php $no=0;?>
										<?php $__currentLoopData = $tb_permit_proccess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											<td>
												<div class="pull-right"><a href="/Permit/Preview/<?php echo e($dt->id); ?>" title="Cetak" type="button" class="btn btn-info btn-xs" target="_balnk"><i class="fa fa-print"></i></a></div>
												<?php $no++;echo $no;?>
											</td>
											<td><?php echo e($dt->doc_date); ?></td>
											<td><?php echo ucfirst($dt->category);?></td>
											...
											<td>
												...
												<div class="pull-right">
													...
													<?php if($dt->status_disetujui=='1'){?>
														<?php if($dt->category=='A'){?><button title="Approve" type="button" class="approve-modal btn btn-success btn-xs" data-approveid="<?php echo e($dt->id); ?>" data-approvename="<?php echo e($dt->employee_name); ?>"><i class="fa fa-check-square-o"></i></button> <?php }else{?>
														<button title="Approve" type="button" class="approve-modals btn btn-success btn-xs" data-sysid="<?php echo e($dt->id); ?>" data-employeename="<?php echo e($dt->employee_name); ?>" data-start="<?php echo e($start); ?>" data-finish="<?php echo e($finish); ?>" data-minutes="<?php echo e($dt->minutes); ?>" data-category="<?php echo e($dt->category); ?>"><i class="fa fa-check-square-o"></i></button>
														<?php }?>
														<button title="Refuse" type="button" class="refuse-modal btn btn-warning btn-xs" data-refuseid="<?php echo e($dt->id); ?>" data-refusename="<?php echo e($dt->employee_name); ?>"><i class="fa fa-close"></i></button>
													<?php }?>
													<?php if(request()->user()->hasRole('root')||request()->user()->hasRole('hr_access')): ?>
														<button title="Delete" type="button" class="delete-modal btn btn-danger btn-xs" data-delid="<?php echo e($dt->id); ?>" data-delname="<?php echo e($dt->employee_name); ?> for <?php echo e($dt->apply_date); ?>"><i class="fa fa-trash"></i></button>
													<?php endif; ?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_permit\permit_personalia.blade.php ENDPATH**/ ?>