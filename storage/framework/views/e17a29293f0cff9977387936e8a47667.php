								...
								<tr>
									...
									<td>
										...
										<?php if(request()->user()->hasRole('hr_access')): ?>
											<button class="btn btn-success btn-xs reactive" data-id="<?php echo e($dt->id); ?>">
...
<?php $__env->startSection('Scripts'); ?>
	...
	<script>
		$(document).on('click', '.reactive', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo e($site); ?>/Policy/Reactive",
				data: {
					id: id,
					_token: $('meta[name="csrf-token"]').attr('content')
				},
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/policy/policy_arsif.blade.php ENDPATH**/ ?>