				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<a href='/Status/KSK/Create/{{$periode}}'><button type="button" class="btn btn-default btn-xs"><i class="fa fa-backward"></i> &nbsp;BACK</button></a>
							<a href='/Status/KSK/Performance/{{$id_ksk}}/{{$periode}}'><button type="button" class="btn btn-info btn-xs"><i class="fa fa-star-half-o"></i> &nbsp;PERFORMANCE</button></a>
							@if($id_ksk>0)
								...
								<tr>
									...
									<td>
										...
										<div class="pull-right">
											<?php if($dt->judge==''){?>
												<button type="button" class="btn btn-warning btn-xs refresh-modal" data-idkskdetail='{{$dt->id}}'><i class="fa fa-refresh"></i></button>
												<button type="button" class="btn btn-primary btn-xs update-modal" data-idksk='{{$dt->id}}' data-warningletter='{{$dt->warning_letter}}' data-sick='{{$dt->sick}}' data-permit='{{$dt->permit}}' data-alpa='{{$dt->alpa}}' data-late='{{$dt->late}}' data-minutes='{{$dt->minutes}}' data-performance='{{$dt->performance}}'><i class="fa fa-edit"></i></button>
												<?php }?>
										</div>
									</td>
								</tr>
