                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="pull-right">
                                <a href="<?php echo e(url('/payroll/summary_assignment/' . $start . '/' . $end)); ?>"
                                    class="btn btn-default btn-md"><i class="fa fa-angle-double-left"></i> &nbsp;Back</a>
                                <a href="/payroll/tax_overtime_approval/Assignment/<?php echo e($periode); ?>"
                                    class="btn btn-info btn-md"><i class="fa fa-edit"></i> &nbsp;Add Approval</a>
                                <button class="btn btn-success btn-md"
                                    onclick="exportTableToExcel('payroll-table', 'Assignment_Summary_<?php echo e($periode); ?>')"><i
                                        class="fa fa-file-excel-o"></i>
                                    &nbsp;Save as Excel</button>
                                <a href="/payroll/tax_assignment_pdf/<?php echo e($start); ?>/<?php echo e($end); ?>" class="btn btn-danger btn-md"
                                        ...
                                        <?php $__currentLoopData = $groupedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept_code => $cc_codes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $cc_codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cc_code => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr style="font-weight: bold; background-color: #f9f9f9;">
                                                    <td colspan="5" class="text-right">Sub Total CC <?php echo e($cc_code); ?></td>
                                            ...
                                            <tr style="font-weight: bold; background-color: #e9e9e9;">
                                                <td colspan="5" class="text-right">Sub Total Dept <?php echo e($dept_code); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\payroll\summary_assignment_excel.blade.php ENDPATH**/ ?>