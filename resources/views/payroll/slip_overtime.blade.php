        ...
        <tbody>
            ...
            @foreach($dates as $date)
                ...
                <tr>
                    ...
                    <td>{{ $uang_lembur || $uang_makan_ot ? number_format($uang_makan_ot, 0, '.', ',') : ($ot ? '0' : '') }}</td>
                    <td>{{ $uang_lembur || $uang_makan_tl ? number_format($uang_makan_tl, 0, '.', ',') : ($ot ? '0' : '') }}</td>
            ...
            <tr>
                ...
                <td>{{ number_format($grand_total_bayar, 0, '.', ',') }}</td>
            </tr>
        </tbody>
    </table>
                ...
                <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                    <table class="bottom-right" style="width:200px;" align="right">
                        ...
                        <tr>
                            ...
                            <td class="val"><strong>{{ number_format(($grand_total_bayar + ($summary->rapel_amount ?? 0)) - ($summary->pph21_amount ?? 0), 0, '.', ',') }}</strong></td>
                        </tr>
                    </table>
                </td>
            </tr>
