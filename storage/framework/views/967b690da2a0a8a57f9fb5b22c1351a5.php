							...
							<div class="form-group">
								...
								<select name="id_employee" id="id_employee" class="form-control selectpicker" data-live-search="true">
									...
									<?php $__currentLoopData = $tb_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($dt2->id); ?>"><?php echo e($dt2->employee_name); ?> (<?php echo e($dt2->NIK); ?>)</option>
								...
								<tr>
									...
									<td>
										...
										<div class="pull-right">
											<?php if($dt->status_disetujui=='0'&&$dt->admin==$nama){?><button title="Delete" type="button" class="delete-modal btn btn-danger btn-xs" data-delid="<?php echo e($dt->id); ?>" data-delname="<?php echo e($dt->employee_name); ?> for <?php echo e($dt->apply_date); ?>"><i class="fa fa-trash"></i></button><?php }?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_permit\permit.blade.php ENDPATH**/ ?>