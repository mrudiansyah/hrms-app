...
<?php if($tb_overtime_detail_count > 0 ) { ?>
	...
	<?php $adminspl=$dt->admin;?>
				<table style="width:100%;" border="1" cellspacing="0" class="tabelot">
					<tr>
						<td colspan="4" style="padding:5px;"><img src="{{ base_path() }}/public/gambar/logosai.png" style="width:160px;"></td>
						...
						<td colspan="6" style="width:220px;text-align:left;">
							<table style="width:100%;" border="0">
								<tr>
									...
									<td title="{{$dt->id_overtime}}" style="text-align:left;">: {{$dt->id_overtime}}</td>
								</tr>
								<tr>
									<td style="text-align:left;">Divisi</td>
									<td style="text-align:left;">: {{$dt->dept_name}}</td>
								</tr>
								<tr>
					...
					<tr>
						<td style="font-size:10px;padding:3px;">{{$no}}</td>
						<td style="text-align:left;padding:4px"><?php echo strtoupper($dt2->employee_name);?></td>
						<td style="font-size:10px;">{{$dt2->NIK}}</td>
						<td style="font-size:8px;">{{$dt2->dept_code}}</td>
						<td style="font-size:9px;text-align:left;padding:4px;">{{$dt2->reason}}</td>
					...
					<tr>
						...
						<td style="border-left:0px;border-right:0px;"><input type="text" value="{{$no}}" style="width:50px;height:20px;font-size:16px;"></td>
								...
								<tr>
									...
									<td class="relative">
										<?php if($dt->dicatat!=''){?>
											...
											<?php if($dt->status_dicatat=='1'){?><img src="{{ $ttd_dik }}" class="absolute"><?php }?>
											<?php if($dt->status_dicatat=='3'){?><img src="{{ base_path() }}/public/approval/rejected.png" style="width:100px;height:40px;"><?php }?>
										<?php }?>
									</td>
								</tr>
								<tr>
					...
					<tr>
						<td colspan="13" style="border:1px solid #000;padding:5px;text-align:left;">
							<div style="font-size:10px;padding:5px;border:0px;">
								<label>CREATED BY {{$adminspl}} </label>
								<ul>
									<li></li>
