      ...
      <div class="row">
        <div class="col-xs-6 col-sm-6 col-lg-3">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo e($data['permanen_pre']); ?><sup style="font-size: 20px">%</sup></h3>

              <p><?php echo e($qty_permanent); ?> Persons (<?php echo e($qty_permanent); ?>/<?php echo e($qty_active); ?>)</p>
            </div>
            <div class="icon">
              <i class="ion ion-person"></i>
            </div>
            <a href="#" class="small-box-footer">Permanent <?php echo e($pre_permanent); ?>% (<?php echo e($qty_permanent); ?>/<?php echo e($qty_sai); ?>)</a>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-lg-3">
          <!-- small box -->
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo e($data['kontrak_pre']); ?><sup style="font-size: 20px">%</sup></h3>

              <p><?php echo e($qty_kontrak); ?> Persons (<?php echo e($qty_kontrak); ?>/<?php echo e($qty_active); ?>)</p>
            </div>
            <div class="icon">
              <i class="ion ion-person"></i>
            </div>
            <a href="#" class="small-box-footer">Contract <?php echo e($pre_kontrak); ?>% (<?php echo e($qty_permanent); ?>/<?php echo e($qty_sai); ?>)</a>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-lg-3">
          <!-- small box -->
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo e($data['magang_pre']); ?><sup style="font-size: 20px">%</sup></h3>

              <p><?php echo e($qty_magang); ?> Persons (<?php echo e($qty_magang); ?>/<?php echo e($qty_active); ?>)</p>
            </div>
            <div class="icon">
              <i class="ion ion-person"></i>
            </div>
            ...
            ?>
            <a href="#" class="small-box-footer" title="<?php echo e($qty_magang); ?>/<?php echo e($qty_sai); ?>, Ideal:<?php echo e($ideal); ?> Over:<?php echo e($over); ?>">
              Magang <?php echo e($pre_magang_comp); ?>% (<?php echo e($qty_magang); ?>/<?php echo e($qty_sai); ?>)
            </a>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-lg-3">
          ...
          <div class="small-box bg-primary">
            <div class="inner">
              <h3><?php echo e($qty_active); ?> <sup style="font-size: 20px">person</sup></h3>
                ...
                <div class="col-xs-4 col-sm-3 col-lg-3">
                  <div class="pad box-pane-right bg-green" style="min-height: 375px">
                   <div class="description-block margin-bottom">
                      ...
                      <h5 class="description-header"><?php echo e($n_total); ?></h5>
                      <span class="description-text">Employees</span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block margin-bottom">
                      <div class="sparkbar pad" data-color="#fff"><i class="fa fa-bar-chart fa-2x"></i></div>
                      <h5 class="description-header"><?php echo e($p_area); ?>%</h5>
                      <span class="description-text"><?php echo e($nilai); ?></span>
                    </div>
                    <!-- /.description-block -->
                    <div class="description-block">
                      <div class="sparkbar pad" data-color="#fff"><i class="fa fa-bar-chart fa-2x"></i></div>
                      <h5 class="description-header"><?php echo e($p_luar); ?>%</h5>
                      <span class="description-text">Luar <?php echo e($nilai); ?></span>
                    </div>
                  </div>
                </div>
                <!-- /.col -->
              ...
              <div class="box-footer" style="border:0px;">
                <div class="box box-info collapsed-box" style="border:0px;">
                  <div class="box-header with-border">
                    ...
                    <h3 class="box-title" title="<?php echo e($periode); ?>"><label>Finish Contact on 1 Month Later: <?php echo e($qty_kontrak); ?> person</label></h3>
                    <div class="box-tools pull-right">
                  ...
                  <div class="box-body" style="padding:10px;">
                    ...
                    <?php if(isset($tb_kontrak)){?>
                      <table id="table3" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <?php $no=0;?>
                          <?php $__currentLoopData = $tb_kontrak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <?php $__empty_1 = true; $__currentLoopData = $upcomingHolidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php 
                  ...
                  ?>
                  <li>
                    <a href="#" title="<?php echo e($holiday->description); ?>">
                      <i class="fa <?php echo e($iconClass); ?>"></i> <?php echo e(date('D, d M Y', strtotime($holiday->date_off))); ?> 
                      <?php echo e($holiday->short_description); ?>

                      <span class="label <?php echo e($labelClass); ?> pull-right"><?php echo e($holiday->category); ?></span>
                    </a>
                  </li>
  ...
  <div class="modal-dialog box box-primary" style="width:95%;">
    <div class="modal-content" style="height:100%;">
      ...
      <div class="modal-body relative">
        ...
        <img src="<?php echo e(asset('public/gambar/notif_update.png')); ?>" style="width:100%;">
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<?php $__env->startSection('Scripts'); ?>
  ...
  <script>
		var chartData = {
			labels: [
				<?php $__currentLoopData = $date_labels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                '<?php echo e($label); ?>',
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			],
			datasets: [{
				...
				data: [
					<?php $__currentLoopData = $chart_kontrak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    '<?php echo e($val); ?>',
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				],
				yAxisID: 'y-axis-1',
				...
				data: [
					<?php $__currentLoopData = $chart_magang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    '<?php echo e($val); ?>',
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				],
				yAxisID: 'y-axis-1',
    ...
    $(function () {
      ...
      $('#calendar').fullCalendar({
        ...
        events    : [
          ...
          ?>
          {
            title          : '<?php echo e($row->category); ?>',
            start          : new Date(<?php echo e($y); ?>, <?php echo e($m); ?>, <?php echo e($j); ?>),
            backgroundColor: '<?php echo e($latar); ?>',
            url            : '', 
            borderColor    : '<?php echo e($latar); ?>' 
          },
          <?php }?>
          {
            title          : 'today',
  ...
  <script type="text/javascript">
	...
	<script>
      ...
      var qtyksk="<?php echo e($qty_ksk); ?>";
      var notif="<?php echo e($notif); ?>";
      if(notif==1){
    ...
    function Notifikasi(){
        $.ajax({
          type: "POST",
          url: "<?php echo e(route('Dashboard.Notifikasi')); ?>",
          data: data,
          dataType: "json",
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/dashboard/index.blade.php ENDPATH**/ ?>