...
<?php $__env->startSection('Contents'); ?>
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<div class="row" style="height:70px;">
						...
						<?php }else{?>
							...
							<select name="id_employee" id="idemployee" class="form-control selectpicker" data-live-search="true">
								...
								<?php $__currentLoopData = $tb_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($dt2->id); ?>"><?php echo e($dt2->employee_name); ?></option>
					...
					<div class="col-lg-9 col-sm-6 col-xs-3">
						<?php $__currentLoopData = $tb_employee_leave; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php
								$min_leave=0;
								if($dt->start>$Tgl){
							...
							<?php if(isset($tb_employee_leave)){?>
								<?php if($status=='0'&&$dt->extend>=$Tgl){?>
									<?php if(request()->user()->hasRole('hr_access')){?>
										<a class='btn btn-app pull-right' href="/Leave/Active/<?php echo e($id_cuti); ?>"><i class='fa fa-wrench'></i>Activated</a>
									<?php }?>
								...
								<?php if(request()->user()->hasRole('hr_access')&&$minExtend<=$Tgl&&$Tgl<=$dt->extend){?>
									<!-- <a class='btn btn-app pull-right' href="/Leave/Extend/<?php echo e($id_cuti); ?>"><i class='fa fa-clock-o'></i>Extend</a> -->
								<?php }?>
							<?php }?>
							<input type="hidden" id="leavecode" value="<?php echo e($code); ?>">
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</div>
				</div>
			</div>
			<div class="box-body">
				...
				<div style="padding:15px;background:#FFF;overflow-x:scroll;">
						<?php $__currentLoopData = $tb_employee_leave; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<input type="hidden" id="idkaryawan" value="<?php echo e($dt->id_employee); ?>">
							...
							<tr>
								<td style="border:1px solid #000;padding:10px 5px;">
									<table style="width:100%;" class="tabeljudul">
										<tr>
											<td style="width:240px;"><img src="<?php echo e(asset('/public/gambar/logosai.png')); ?>" style="width:300px;"></td>
									...
									<table style="width:100%;" class="tabeljudul">
										<tr>
											...
											<td style="width:40%;text-align:right;padding-right:30px;font-size:16px;">
												PERIODE CUTI : &nbsp;&nbsp;<b><?php echo e($dt->year); ?></b>&nbsp;&nbsp; (<?php echo date('d F Y',strtotime($dt->start)).' ~ '.date('d F Y',strtotime($dt->end));?>)
											</td>
										</tr>
									</table>
								</td>
											...
											<td style="width:60%;border:0px;border-right:1px solid #000;padding:20px 20px 30px 20px;text-align:left;">
												<table style="width:100%;" class="tabelsubjudul">
													...
													<tr>
														...
														<td style="border-bottom:1px dotted #000;"><b><?php echo e($dt->employee_name); ?></b></td>
														<td style="width:30px;">&nbsp;</td>
														<td style="width:80px;">NIK</td>
														<td style="width:10px;">:</td>
														<td style="border-bottom:1px dotted #000;"><b><?php echo e($dt->NIK); ?></b></td>
													</tr>
													<tr>
														<td>DIVISI/SUB DIVISI</td>
														<td>:</td>
														<td style="border-bottom:1px dotted #000;"><b><?php echo e($dt->dept_name); ?></b></td>
														<td>&nbsp;</td>
														<td>JABATAN</td>
														<td>:</td>
														<td style="border-bottom:1px dotted #000;"><b><?php echo e($dt->position_name); ?></b></td>
													</tr>
													<tr>
														<td>
															...
															<div class="pull-right">
																<?php if($leader_name==''){?>
																	<!-- <a href="/Admin/Employee/Update/<?php echo e($dt->id_employee); ?>" target="_blank"><i class="fa fa-edit"></i></a> -->
																<?php }?>
															</div>
														</td>
														<td>:</td>
														<td style="border-bottom:1px dotted #000;">
															<b><?php echo e($leader_name); ?></b>
														</td>
														<td>&nbsp;</td>
														<td colspan='3'>
															<div class="pull-left">
																<?php if (request()->user()->hasRole('hr_access')){?>
																	<br>
																	<div class="form-group"><input type="checkbox" data-idleave="<?php echo e($id_leave); ?>" id="qtyapproval" <?php if($dt->qty_approval==2)echo "checked";?>>&nbsp;2 Approval</div>
																<?php }?>
															</div>
												...
												<table style="width:100%;" class="tabelsubjudul">
													...
													<tr>
														<td>
															...
															<div class="pull-right">
																<?php if (request()->user()->hasRole('hr_access')){?>
																	<i class="fa fa-edit" data-idot="<?php echo e($dt->id); ?>" style="cursor:pointer;" id="sisacuti"></i>
																<?php }?>
															</div>
													...
													<tr>
														<td>
															...
															<div class="pull-right">
																<?php if (request()->user()->hasRole('hr_access')){?>
																	<i class="fa fa-edit" data-idot="<?php echo e($dt->id); ?>" style="cursor:pointer;" id="kurangcuti"></i>
																<?php }?>
															</div>

														</td>
														<td>:</td>
														<td style="text-align:center;border-bottom:1px dotted #000;"><b><?php echo e($dt->kurang); ?></b></td>
														<td style="text-align:right;">hari</td>
													</tr>
													<tr>
							...
							<tr>
								<td style="border:1px solid #000;text-align:center;border:0px;">
									<table style="width:100%;" class="tabelisi">
										...
										<?php $no=0;?>
										<?php $__currentLoopData = $tb_anual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php 
											$no++;
										...
										<?php if($dt2->status_legalized<2){?>
											<tr <?php echo $warna;?>>
												<td><?php echo e($dt2->start_leave); ?></td>
												<td><?php echo e($dt2->finish_leave); ?></td>
												<td><?php echo e($dt2->start_working); ?></td>
												<td <?php echo $efek;?> ><?php echo e($dt2->leave_count); ?> / <?php echo e($outstanding); ?></td>
												<td><?php echo e($dt2->reason); ?>, <?php echo e($dt2->remark); ?></td>
												<td class="relative">
													<?php 
												...
												<td class="relative" style="width:75px;">
													<?php 
														if($dt2->status_approved=='1'){
															...
															if (file_exists($filename)){?>
																<i style="color:#FFF;">&nbsp;</i>
																<img src='<?php echo e($ttd_app); ?>' class="absolute" title="<?php echo e($dt2->approved_name); ?>, <?php echo e($dt2->date_approved); ?>">
															<?php }else{echo "Confirm";}
													...
													<?php 
														if($dt2->status_approved2=='1'){
															...
															if (file_exists($filename)){?>
																...
																<img src='<?php echo e($ttd_app); ?>' class="absolute" title="<?php echo e($dt2->approved1_name); ?>, <?php echo e($dt2->date_approved2); ?>">
															<?php }else{echo "Confirm";}
							...
							<tr>
								<td style="border:1px solid #000;text-align:center;border:0px;">
									<table style="width:100%;" class="tabelisi">
										...
										<?php $no=0;?>
										<?php $__currentLoopData = $tb_docter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $no++;?>
										<tr>
											<td><?php echo e($dt2->start_leave); ?></td>
											<td><?php echo e($dt2->finish_leave); ?></td>
											<td><?php echo e($dt2->start_working); ?></td>
											<td><?php echo e($dt2->leave_count); ?></td>
											<td><?php echo e($dt2->remark); ?></td>
											<td>Confirm</td>
							...
							<tr>
								<td style="border:1px solid #000;text-align:center;border:0px;">
									<table style="width:100%;" class="tabelisi">
										...
										<?php $no=0;?>
										<?php $__currentLoopData = $tb_special; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $no++;
											if($dt2->status_approved<2&&$dt2->status_approved2<2&&$dt2->status_legalized<2){
												$warna="";
												$efek="";
	...
	<div class="modal fade" id="modal-update">
		<div class="modal-dialog box box-primary" style="width:350px;">
			...
			<input type="hidden" name="id_leave" value="<?php echo e($id_leave); ?>">
			<input type="hidden" name="id_doc" id="0">
			<input type="hidden" name="leader_id" value="<?php echo e($leader_id); ?>">
				...
				<div class="modal-body">
					<div class="col-xs-8" style="padding:0px;padding-right:3px;">
						<div class="form-group">
							...
							<input type="hidden" id="sisa_anual" value="<?php echo e($sisa_anual); ?>">
						</div>
					</div>
					...
					<div class="col-xs-6" style="padding:0px;padding-right:3px;">
						<div class="form-group">
							...
							<input type="hidden" id="tglmin" class="form-control" value="<?php echo e($MinTgl); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<!-- <input type="date" name="start_working" class="form-control" min="<?php echo e($Tgl); ?>"> -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_leave/leaves.blade.php ENDPATH**/ ?>