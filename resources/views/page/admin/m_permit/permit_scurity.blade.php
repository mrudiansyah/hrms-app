										...
										<tr>
											...
											<td>
												...
												<div class="pull-right">
													...
													<button title="Approve" type="button" class="approve-modal btn btn-success btn-xs" data-sysid="{{$dt->id}}" data-employeename="{{$dt->employee_name}}" data-start="{{$start}}" data-finish="{{$finish}}" data-minutes="{{$dt->minutes}}" data-category="{{$dt->category}}"><i class="fa fa-check-square-o"></i></button>
													<?php }?>
