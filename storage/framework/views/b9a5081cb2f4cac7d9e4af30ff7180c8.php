										...
										echo $no;?></td>
																		<td>
																			...
																			<div class="pull-right">
																				<a href="/ESS/Document/Download/<?php echo e($dt->id_doc); ?>" title="Download"
				...
				<div class="col-lg-7 col-md-12 col-xs-12">
					<div class="box box-success" style="background:#FFF;">
						<div class="box-header">
							...
							<div class="box-tools pull-right">
								<a href="/Training/Actual/<?php echo e($id_training); ?>" id="savechange"><button type="button"
																			...
																			<div class="pull-right">
																				<?php if($dt->free_test == '' && $in_class == 1): ?>
																					<button title="Delete" type="button"
																						class="delete-modal btn btn-danger btn-xs" data-delid="<?php echo e($dt->id); ?>"
																						data-delname="<?php echo e($dt->nama_karyawan); ?>"><i
								...
								<thead>
									<tr>
										...
										<th>
											Free Test
											<div class="box-tools pull-right">
												<a href="/Training/Monitor/Free/<?php echo e($id_training); ?>" title="Monitoring"
										...
										<th>
											Post Test
											<div class="box-tools pull-right">
												<a href="/Training/Monitor/Post/<?php echo e($id_training); ?>" title="Monitoring"
													type="button" class="btn btn-primary btn-xs"><i
														class="fa fa-tv"></i></a>
											</div>
										</th>
					...
					<div class="box box-warning" style="background:#FFF;">
						...
						<div class="box-body" style="overflow-x: scroll;">
							<table id="table6" class="table table-hover">
								...
								<tbody id="supporting">
									<?php $assign=0;?>
									<?php $__currentLoopData = $tb_training_assignment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td><?php $assign++;echo $assign;?></td>
										<td><?php echo e($dt->assignment); ?></td>
										<td>
											<?php echo e($dt->duedate); ?>

											<div class="pull-right">
												<button title="Edit" type="button" class="assignment-edit btn btn-primary btn-xs" data-id="<?php echo e($dt->id); ?>" data-assignment="<?php echo e($dt->assignment); ?>" data-duedate="<?php echo e($dt->duedate); ?>"><i class="fa fa-edit"></i></button>
												<button title="Delete" type="button" class="assignment-delete btn btn-danger btn-xs" data-id="<?php echo e($dt->id); ?>" data-assignment="<?php echo e($dt->assignment); ?>"><i class="fa fa-trash"></i></button>
											</div>
										</td>
									</tr>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			...
			<div class="modal-content">
				<form id="assignment-form">
					...
					<div class="modal-body">
						...
						<input type="hidden" name="id_training_actual" value="<?php echo e($id_training); ?>">
						<div class="form-group">
		...
		$(document).on('click', '.assignment-delete', function () {
			...
			$.ajax({
				...
				data: {
					...
					id_training_actual: "<?php echo e($id_training); ?>"
				},
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
				},
