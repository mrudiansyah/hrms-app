...
<?php $__env->startSection('Contents'); ?>
	...
	foreach ($tb_question as $dt) {
		...
		echo " <div class='form-group col-lg-6 col-md-6'><b>B</b><div class='radio pilihan' data-idquestion='" . $dt->id . "' data-isi='B'><label class=''><input type='radio' name='pilihan" . $dt->index_question . "' id='" . $dt->index_question . "#" . $id_participant . "' value='B'";
		if ($dt->answer_actual == 'B')
			echo ' checked';
		echo ">" . $dt->option_b . "</label></div></div>";
		echo "<div class='form-group col-lg-6 col-md-6'><b>C</b><div class='radio pilihan' data-idquestion='" . $dt->id . "' data-isi='C'><label class=''><input type='radio' name='pilihan" . $dt->index_question . "' id='" . $dt->index_question . "#" . $id_participant . "' value='C'";
		if ($dt->answer_actual == 'C')
			echo ' checked';
		echo ">" . $dt->option_c . "</label></div></div>";
		echo "<div class='form-group col-lg-6 col-md-6'><b>D</b><div class='radio pilihan' data-idquestion='" . $dt->id . "' data-isi='D'><label class=''><input type='radio' name='pilihan" . $dt->index_question . "' id='" . $dt->index_question . "#" . $id_participant . "' value='D'";
						...
						<div class="box box-primary" style="background:#FFF;">
							<div class="box-header">
								...
								<div class="box-tools pull-right">
									...
									<button id="finishtest" title="Examination" type="button" class="btn btn-primary">Finish
										Test &nbsp;<i class="fa fa-angle-double-right"></i></button>
								</div>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\training\training_free_test.blade.php ENDPATH**/ ?>