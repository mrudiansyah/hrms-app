							...
							<tbody id="supporting">
								...
								<tr>
									...
									<td>
										{{$dt->file_name}}
										<div class="pull-right">
											<button title='Delete' type='button' class='deletesupport-modal btn btn-danger btn-xs' data-supportid='{{$dt->id}}' data-supportname='{{$dt->file_name}}'><i class='fa fa-trash'></i></button>
										</div>
									</td>
								</tr>
								@endforeach
							...
							<tbody id="supporting">
								...
								<tr>
									...
									<td>
										{{$dt->passing_grade}}
										<div class="pull-right">
											<button title="Delete" type="button" class="deletetest-modal btn btn-danger btn-xs" data-deltest="{{$dt->id}}" data-delnametest="{{$dt->test_name}}"><i class="fa fa-trash"></i></button>
										</div>
									</td>
								</tr>
								@endforeach
							...
							<tbody id="konten">
								...
								<tr>
									...
									<td>
										{{$dt->jabatan}}
										<div class="pull-right">
											<button title="Delete" type="button" class="delete-modal btn btn-danger btn-xs" data-delid="{{$dt->id}}" data-delname="{{$dt->nama_karyawan}}"><i class="fa fa-trash"></i></button>
										</div>
									</td>
								</tr>
								@endforeach
					...
					{{ csrf_field() }}
						...
						<div class="modal-body">
							...
							<select id="iddocument" class="form-control selectpicker" data-live-search="true">
								<option value=""></option>
								@foreach($tb_training_document as $dt2)
									<option value="{{$dt2->id}}">{{$dt2->document_name}}</option>
								@endforeach
					...
					{{ csrf_field() }}
						...
						<div class="modal-body">
							...
							<select id="idtest" name="id_test" class="form-control selectpicker" data-live-search="true">
								<option value=""></option>
								@foreach($tb_training_test as $dt2)
									<option value="{{$dt2->id}}">{{$dt2->test_name}}</option>
								@endforeach
