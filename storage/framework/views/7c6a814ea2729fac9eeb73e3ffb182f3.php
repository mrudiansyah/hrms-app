				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<a href='/Admin/Employee'><button type="button" class="btn btn-default btn-md"><i class="fa fa-home"></i> &nbsp;Home</button></a>
						</div>
					</div>
					<div class="box-body">
						...
						<table id="tables" class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($dt->level_education); ?></td>
									<td><?php echo e($dt->prodi); ?></td>
									<td><?php echo e($dt->institute); ?></td>
									<td><?php echo e($dt->graduate_year); ?></td>
								</tr>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_employee\employee_education.blade.php ENDPATH**/ ?>