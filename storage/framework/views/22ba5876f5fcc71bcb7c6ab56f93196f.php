                ...
                <div class="box-body">
                  ...
                  <div class="row" style="padding:15px;">
                    <div class="col-xs-6" style="padding:0px;padding-right:3px;">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" id="idkaryawan" name="id_employee" value="<?php echo e($id_employee); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select id="diagnosalist" class="selectpicker form-control" data-live-search="true">
                      <option value=""></option>
                      <?php $__currentLoopData = $tb_diagnosa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diagnosa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($diagnosa->diagnosa); ?>"><?php echo e($diagnosa->diagnosa); ?></option>
      ...
      <form role="form" action="/SKD/NIK/Check" method="post">
          ...
          <div style="width:330px;">
              ...
              <div class="input-group">
                  <input type="text" placeholder="Nomor Induk Karyawan . . ." name="NIK" class="form-control" style="width:100%;" value="<?php echo e($NIK); ?>">
...
<?php echo $__env->make('layouts/home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_permit/skd.blade.php ENDPATH**/ ?>