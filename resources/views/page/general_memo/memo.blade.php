			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<h3 class="box-title">New Memo <small>(Tanggal >= {{$data['today']}})</small></h3>
						<div class="box-tools pull-right">
							<button class="btn btn-primary btn-md create-modal" data-id_memo="" data-id_template_memo="" data-date_information="{{$data['today']}}" data-additional_information="">
								<i class="fa fa-plus"></i> &nbsp;Create
							</button>
							<a class="btn btn-default btn-md" href="/ArchieveMemo/{{$data['category']}}/0">
					...
					<form role="form" action="" method="post">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<input type="date" name="date_information" id="date_information" class="form-control" min="{{$today}}">
							</div>
							<div class="form-group">
