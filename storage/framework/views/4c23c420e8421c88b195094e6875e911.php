...
<head>
    <meta charset="utf-8">
    <title>Employee Status Renewal - <?php echo e($renewal->nik); ?></title>
    <style>
        * {
                                ...
                                <table class="sub-table" style="width: 100%;">
                                    <tr>
                                        <td style="padding: 0px; vertical-align: middle;">
                                            <img src="<?php echo e(public_path('images/logosai2.png')); ?>"
                                ...
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->date_of_join ? date('d/m/Y', strtotime($renewal->date_of_join)) : ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->work_period ?? ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->last_renewal ? date('d/m/Y', strtotime($renewal->last_renewal)) : ''); ?>
                            ...
                            <td style="width: 50%; padding: 4px 8px; vertical-align: top;">
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td style="width: 10px; padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->last_position ?? ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->last_division ?? ''); ?>
                            ...
                            <td style="width: 50%; padding: 4px 8px; vertical-align: top; border-left: 2px solid #000;">
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td style="width: 10px; padding: 2px 0; text-align: center;">:</td>
                                        <td class="value bold-val" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->new_position ?? ''); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px 0; text-align: center;">:</td>
                                        <td class="value bold-val" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->new_division ?? ''); ?>
                            ...
                            <td style="width: 50%; padding: 4px 8px; vertical-align: top; height: 65px;">
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td style="width: 10px; padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->last_salary ? 'Rp ' . number_format($renewal->last_salary, 0, ',', '.') : ''); ?>
                            ...
                            <td
                                ...
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td style="width: 10px; padding: 2px 0; text-align: center;">:</td>
                                        <td class="value bold-val" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->new_salary ? 'Rp ' . number_format($renewal->new_salary, 0, ',', '.') : ''); ?>
                            ...
                            <td style="width: 50%; padding: 4px 8px; vertical-align: top; height: 65px;">
                                <table class="sub-table">
                                    <tr>
                                        ...
                                        <td style="width: 10px; padding: 2px 0; text-align: center;">:</td>
                                        <td class="value" style="padding: 2px 0 2px 3px;">
                                            <?php echo e($renewal->last_others ?? ''); ?>
            ...
            <tr>
                <td class="section-divider" style="padding: 5px 8px;height:20px; vertical-align: middle;">
                    ...
                    <span class="value bold-val" style="margin-left: 4px;">
                        <?php echo e($renewal->effective_from ? date('d/m/Y', strtotime($renewal->effective_from)) : ''); ?>
                            ...
                            <td style="width: 50%; padding: 5px 8px; vertical-align: top;">
                                ...
                                <div class="label" style="margin-bottom: 35px;height:60px;">
                                    ...
                                    <div style="text-align: center; width: 100%;">
                                        ...
                                        ?>
                                        <img src="<?php echo e(public_path($imagePath)); ?>" style="max-width: 200px; max-height: 70px; display: inline-block;" alt="Logo">
                                    </div>
                                </div>
                                <div class="label" style="padding-top: 4px;">
                                    <strong>NAME / Nama :</strong> <span
                                        class="value"><?php echo e($renewal->suggested_by_name ?? ''); ?></span>
                                </div>
                                <div class="label">
                                    <strong>DATE / Tanggal :</strong> <span
                                        class="value"><?php echo e($renewal->suggested_by_date ? date('d/m/Y', strtotime($renewal->suggested_by_date)) : ''); ?></span>
                                </div>
                            </td>
                            <!-- Supported By -->
                            <td style="width: 50%; padding: 5px 8px; vertical-align: top; border-left: 2px solid #000;">
                                ...
                                <div class="label" style="padding-top: 4px;">
                                    <strong>NAME / Nama :</strong> <span
                                        class="value"><?php echo e($renewal->supported_by_name ?? ''); ?></span>
                                </div>
                                <div class="label">
                                    <strong>DATE / Tanggal :</strong> <span
                                        class="value"><?php echo e($renewal->supported_by_date ? date('d/m/Y', strtotime($renewal->supported_by_date)) : ''); ?></span>
                                </div>
                            </td>
                        </tr>
                    </table>
                            ...
                            <td style="width: 25%; padding: 4px 8px; vertical-align: bottom; height: 55px;">
                                <div class="label" style="margin-bottom: 3px;">
                                    <strong>NAME / Nama :</strong> <span class="value"
                                        style="font-size: 8.5px;"><?php echo e($renewal->personnel_name ?? ''); ?></span>
                                </div>
                                <div class="label">
                                    <strong>DATE / Tanggal :</strong> <span class="value"
                                        style="font-size: 8.5px;"><?php echo e($renewal->personnel_date ? date('d/m/Y', strtotime($renewal->personnel_date)) : ''); ?></span>
                                </div>
                            </td>
                            <!-- Right: Description -->
                            <td
                                ...
                                <table class="sub-table" style="margin: 1px 0;">
                                    <tr>
                                        ...
                                        <td class="value" style="width: 80px;">
                                            <?php echo e($renewal->personnel_attendance ?? ''); ?>

                                        </td>
                                        <td class="label" style="width: 100px;">Ketepatan Waktu :</td>
                                        <td class="value"><?php echo e($renewal->personnel_punctuality ?? ''); ?></td>
                                    </tr>
                                </table>
                                <table class="sub-table" style="margin: 1px 0;">
                                    <tr>
                    ...
                    <table class="sub-table" style="margin-top: 10px;">
                        <tr>
                            <td class="label" style="width: 50%; vertical-align: bottom; padding-bottom: 2px;">
                                <strong>NAME / Nama :</strong> <span class="value"
                                    style="font-size: 9px;"><?php echo e($renewal->proposed_by_name ?? ''); ?></span>
                            </td>
                                ...
                                <table class="sub-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="value" style="border-bottom: 1px solid #000; padding: 1px 0;">
                                            <?php echo e($renewal->proposed_by_date ? date('d/m/Y', strtotime($renewal->proposed_by_date)) : ''); ?>
                ...
                <td style="padding: 5px 8px; vertical-align: top; height: 55px;">
                    ...
                    <table class="sub-table" style="margin-top: 10px;">
                        <tr>
                            <td class="label" style="width: 50%; vertical-align: bottom; padding-bottom: 2px;">
                                <strong>NAME / Nama :</strong> <span class="value"
                                    style="font-size: 9px;"><?php echo e($renewal->approved_by_name ?? ''); ?></span>
                            </td>
                            <td style="width: 50%; vertical-align: bottom;">
                                <table class="sub-table">
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label" style="padding: 1px 0;"><strong>DATE / Tanggal :</strong></td>
                                        <td class="value" style="border-bottom: 1px solid #000; padding: 1px 0;">
                                            <?php echo e($renewal->approved_by_date ? date('d/m/Y', strtotime($renewal->approved_by_date)) : ''); ?>
...
</html><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/renewal/pdf.blade.php ENDPATH**/ ?>