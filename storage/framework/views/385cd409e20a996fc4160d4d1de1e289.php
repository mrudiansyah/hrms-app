					...
					<div class="box-body">
						<table id="table2" class="table table-hover">
							...
							<tbody>
								...
								<tr id="R<?php echo e($no); ?>" <?php if($dt->ot_category==2)echo  "style='background:burlywood;'";?>>
									<td><?php echo $no;?></td>
									<td><?php echo e($dt->id_overtime); ?></td>
									<td><?php echo e($dt->date_on); ?></td>
									<td><?php echo e($dt->NIK); ?></td>
									<td><?php echo e($dt->employee_name); ?></td>
									<td title="<?php echo e($dt->start_act); ?> to <?php echo e($dt->finish_act); ?>">
									...
									<td><?php echo e($dt->hours_convertion); ?></td>
									<td><input type="hidden" id="satuan<?php echo e($no); ?>" value="<?php echo e($dt->status); ?>">
										<?php 
										//||$dt->sign_after=='0'
										if($dt->sign_before=='1'&&$dt->status_dicatat=='1'){
											...
											<button type="button" class="btn btn-primary btn-xs update-modal" data-dateon='<?php echo e($dt->date_on); ?>' data-id_employee='<?php echo e($dt->id_employee); ?>' data-idafter='<?php echo e($dt->id); ?>' data-startact='<?php echo e($start_act); ?>' data-finishact='<?php echo e($finish_act); ?>' data-otcategory='<?php echo e($dt->ot_category); ?>' data-hoursact='<?php echo e($dt->hours_act); ?>' data-hoursconvertion='<?php echo e($dt->hours_convertion); ?>' data-otisoma='<?php echo e($dt->minutes_break); ?>' data-harikerja="<?php echo e($dt->hari_kerja); ?>"><i class="fa fa-edit"></i></button>
											<?php if($dt->hari_kerja!=7){?><button title="Yes" id="yes-dip<?php echo e($no); ?>" type="button" class="btn btn-success btn-xs yes-dip" data-nilai="<?php echo e($no); ?>" data-detailid="<?php echo e($dt->id); ?>"><i class="fa fa-check"></i></button><?php }?>
											<?php 
											}?>
											<button title="No" id="no-dip<?php echo e($no); ?>" type="button" class="btn btn-danger btn-xs no-dip" data-nilai="<?php echo e($no); ?>" data-detailid="<?php echo e($dt->id); ?>"><i class="fa fa-close"></i></button>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/verificationspl.blade.php ENDPATH**/ ?>