		...
		<div class="row">
			...
			<div class="box-body">
				<table id="tables" class="table table-bordered">
					...
					<tbody>
						<?php $no=0;?>
						<?php $__currentLoopData = $table1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php $no++;echo $no;?></td>
								<td><?php echo e($dt->kategori); ?></td>
								<td><?php echo e($dt->sub_kategori); ?></td>
								<td><?php echo e($dt->nama); ?></td>
								<td><?php echo e($dt->gender); ?></td>
								<td><?php echo e($dt->nomor_ktp); ?></td>
								<td><?php echo e($dt->tempat_lahir); ?>, <?php echo e($dt->tanggal_lahir); ?></td>
								<td><?php echo e($dt->nomor_hp); ?></td>
								...
								<td>
									...
									<div class="pull-right">
										<?php if($type=='Arsif'): ?>
										<button type="button" class="btn btn-default btn-xs"><a href="/Admin/Employee/Create/Delete/<?php echo e($dt->id); ?>/OtherActive"><i class="fa fa-user-plus"></i></a></button>
										<?php else: ?>
											<button type="button" class="btn btn-primary btn-xs edit-modal" data-iddata="<?php echo e($dt->id); ?>" data-kategori="<?php echo e($dt->kategori); ?>" data-subkategori="<?php echo e($dt->sub_kategori); ?>" data-gender="<?php echo e($dt->gender); ?>" data-nama="<?php echo e($dt->nama); ?>" data-nomorktp="<?php echo e($dt->nomor_ktp); ?>" data-ibukandung="<?php echo e($dt->ibu_kandung); ?>" data-joindate="<?php echo e($dt->join_date); ?>" data-deptcode="<?php echo e($dt->dept_code); ?>" data-pin="<?php echo e($dt->PIN); ?>" data-tempatlahir="<?php echo e($dt->tempat_lahir); ?>" data-tanggallahir="<?php echo e($dt->tanggal_lahir); ?>" data-nomorhp="<?php echo e($dt->nomor_hp); ?>"><i class="fa fa-edit"></i></button>
											<button type="button" class="btn btn-danger btn-xs delete-modal" data-delid="<?php echo e($dt->id); ?>" data-delid1="Other" data-delname="<?php echo e($dt->nama); ?>"><i class="fa fa-trash-o"></i></button>
										<?php endif; ?>
									</div>
								</td>
							</tr>
									...
									<div class="col-xs-12 col-md-6 col-lg-6">
										...
										<div class="form-group">
											...
											<select class="form-control" id="deptcode">
												<option value=""></option>
												<?php $__currentLoopData = $table2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_employee/employee_other.blade.php ENDPATH**/ ?>