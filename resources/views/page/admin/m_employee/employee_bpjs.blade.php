								...
								<tr>
									...
									<td>&nbsp;
										...
										<div class="form-group pull-left">
											<div class="checkbox">
												<label>
												<input type="checkbox" <?php if($dt->status_bpjs_kes=='1')echo "checked";?> class="status_bpjs_kes" id="status_bpjs_kes{{$dt->id_detail}}" data-iddetail="{{$dt->id_detail}}" data-statusbpjskes="{{$dt->status_bpjs_kes}}" data-nokk="{{$dt->nomor_kk}}" data-noktp="{{$dt->nomor_ktp}}" data-bpjskes="{{$dt->nomor_bpjs_kes}}" data-bpjsket="{{$dt->nomor_bpjs_ket}}" <?php if($dt->status_bpjs_kes==1)echo "disabled";?>>
												</label>
											</div>
										</div>
									</td>
									<td>&nbsp;
										...
										<div class="form-group pull-left">
											<div class="checkbox">
												<label>
												<input type="checkbox" <?php if($dt->status_bpjs_ket=='1')echo "checked";?> class="status_bpjs_ket" id="status_bpjs_ket{{$dt->id_detail}}" data-iddetail="{{$dt->id_detail}}" data-statusbpjsket="{{$dt->status_bpjs_ket}}" data-nokk="{{$dt->nomor_kk}}" data-noktp="{{$dt->nomor_ktp}}" data-bpjskes="{{$dt->nomor_bpjs_kes}}" data-bpjsket="{{$dt->nomor_bpjs_ket}}" <?php if($dt->status_bpjs_ket==1)echo "disabled";?>>
												</label>
											</div>
										</div>
									</td>
									<td>
										<button type="button" class="btn btn-primary btn-xs edit-modal" data-iddetail="{{$dt->id_detail}}" data-employeename="{{$dt->employee_name}}" data-nokk="{{$dt->nomor_kk}}" data-noktp="{{$dt->nomor_ktp}}" data-bpjskes="{{$dt->nomor_bpjs_kes}}" data-bpjsket="{{$dt->nomor_bpjs_ket}}" data-statusbpjskes="{{$dt->status_bpjs_kes}}" data-statusbpjsket="{{$dt->status_bpjs_ket}}"><i class="fa fa-edit"></i></button>
									</td>
								</tr>
								@endforeach
							</tbody>
