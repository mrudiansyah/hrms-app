				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<a href="/Training/Invitation" title="Schedule" type="button" class="btn btn-default btn-xs"><i
									class="fa fa-angle-double-left"></i> &nbsp; Kembali</a>
						</div>
					</div>
					<div class="box-body">
					...
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<div class="box-tools">
								<a href="/FreeTest/<?php echo e($id_participant); ?>" <?php if ($data['pre_test'] != '')
		echo "disabled";?>
									title="Free Test" type="button" class="btn btn-primary btn-xs">Start Pre Test</a>
							</div>
						</div>
					</div>
					<div class="box-body">
					...
					<div class="box box-primary" style="background:#FFF;">
						<div class="box-header">
							...
							<div class="box-tools pull-right">
								<div class="box-tools">
									<a href="/PostTest/<?php echo e($id_participant); ?>" <?php if ($data['pre_test'] == '' || ($data['post_test'] != '' && $data['grade_status'] == 1))
		echo "disabled";?>
									...
									<?php $__currentLoopData = $tb_training_participant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<tr>
																		...
																		<td>
																			...
																			<?php if ($dt->progress == '1')
											echo "<i class='fa fa-angle-double-up' style='color:green;'></i>";?>
																			<?php if ($dt->progress == '-1')
											echo "<i class='fa fa-angle-double-down' style='color:red;'></i>";?>
																			<?php if ($dt->progress == '0')
											echo "<i class='fa fa-frown-o' style='color:blue;'></i>";?>
																		</td>
																		...
																		<td>
																			...
																			<?php 
																																					if ($dt->grade_status == 1)
											echo "<label class='label label-success'>Lulus</label>";
										elseif ($dt->grade_status == 0 && $dt->post_test != '')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/home', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\training\training_participant.blade.php ENDPATH**/ ?>