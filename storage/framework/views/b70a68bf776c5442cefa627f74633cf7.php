					...
					<div class="box box-primary" style="background:#FFF;">
						...
						<div class="box-body" style="min-height:200px;overflow-x:scroll;">
							...
							<ul>
								<?php if($code_qty>0): ?>
									<b>ACTIVE CODE</b>:
									<?php $__currentLoopData = $list_code; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li><label class="label label-warning"><?php echo e($li->leader_code); ?></label> <?php echo e($li->employee_name); ?></li>
									...
									<?php $no=0;?>
										...
										<tr>
											<td>
                                                <?php $no++;echo $no;?>
                                                <div class="pull-right">
                                                    <a href="/Leave/Employee/<?php echo e($dt->id_leave); ?>" target="_blank"><button title="Preview" type="button" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></button></a>
                                                </div>
                                            </td>
											<td><?php echo e($dt->doc_date); ?></td>
											<td><?php echo ucfirst($dt->category);?></td>
											<td title="<?php echo e($dt->id_leave); ?>"><?php echo e($dt->NIK); ?></td>
											...
											<td>
												<?php echo e($dt->reason); ?> <?php echo e($dt->remark); ?>

												<div class="pull-right">
                                                    <?php if($dt->overlap_doc!=""): ?>
													<a href="/Download/<?php echo e($dt->overlap_doc); ?>"><i class="fa fa-files-o"></i> Overlapping</a>
                                                    <?php endif; ?>
											</div>
											</td>
											<td>
												...
												<?php }else{?>
													...
													<?php } ?>
												<?php echo e($dt->leader_name); ?><br><?php echo e($dt->date_approved); ?>

												<?php if($dt->status_approved=='0'&&$dt->approved==$id_employee){?>
													<div class="pull-right">
														<button title="Approve" type="button" class="approve-modal btn btn-success btn-xs" data-approveid="<?php echo e($dt->id); ?>" data-approvename="<?php echo e($dt->employee_name); ?>" data-approved="1"><i class="fa fa-check-square-o"></i></button>
														<button title="Refuse" type="button" class="refuse-modal btn btn-danger btn-xs" data-refuseid="<?php echo e($dt->id); ?>" data-refusename="<?php echo e($dt->employee_name); ?>" data-approved="1"><i class="fa fa-close"></i></button>
													</div>
												<?php }?>
											</td>
											<td>
												<?php echo e($dt->leader_name2); ?><br><?php echo e($dt->date_approved2); ?>

												<?php if($dt->status_approved=='1'&&$dt->status_approved2=='0'&&$dt->approved2==$id_employee){?>
													<div class="pull-right">
														<?php if($status_limit==0): ?>
															<button title="Approve" type="button" class="approve-modal btn btn-success btn-xs" data-approveid="<?php echo e($dt->id); ?>" data-approvename="<?php echo e($dt->employee_name); ?>" data-approved="2"><i class="fa fa-check-square-o"></i></button>
															<button title="Refuse" type="button" class="refuse-modal btn btn-danger btn-xs" data-refuseid="<?php echo e($dt->id); ?>" data-refusename="<?php echo e($dt->employee_name); ?>" data-approved="1"><i class="fa fa-close"></i></button>
														<?php else: ?>	
								...
								<table id="tables" class="table table-striped" border="0">
									...
									<?php $no=0;?>
										...
										<tr>
											...
											<td><?php echo e($dt->employee_name); ?></td>
											<td><?php echo e($dt->start_leave); ?><?php if($dt->start_leave!=$dt->finish_leave)echo " ~ ".$dt->finish_leave;?></td>
											...
											<td>
												&nbsp;
												<a href="/Leave/Employee/<?php echo e($dt->id_leave); ?>" target="_blank"><button title="Preview" type="button" class="btn btn-primary btn-xs pull-right"><i class="fa fa-print"></i></button></a>
												<?php
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_leave/approve_leave.blade.php ENDPATH**/ ?>