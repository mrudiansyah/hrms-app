...
@section('Contents')
	<div class="content-wrapper">
		...
		<div class="row">
            <form role="form" action="{{ url('/outside') }}" method="POST">
                @csrf
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="book_id" value="{{ old('book_id') }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nopol" value="{{ old('nopol') }}" required placeholder="e.g. B 1234 ABC">
                            </div>
                        </div>
                        ...
                        <div class="box-body" style="max-height: 600px; overflow-y: auto;">
                            <table id="empTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" name="employees[]" value="{{ $emp->id_employee }}" class="emp-checkbox"></td>
                                        <td>{{ $emp->NIK }}</td>
