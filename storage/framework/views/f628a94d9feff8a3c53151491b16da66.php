...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/assets/bower_components/bootstrap/dist/css/bootstrap-select.min.css')); ?>">
  <!-- daterange picker -->
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/assets/bower_components/fullcalendar/dist/fullcalendar.print.min.css')); ?>"
    media="print">
  <style>
    .fc-time {
      display: none;
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('public/gambar/apple-touch-icon.png')); ?>" type="image/x-icon">
  <link rel="icon" href="<?php echo e(asset('public/gambar/favicon.ico')); ?>" type="image/x-icon">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/assets/bower_components/summernote/summernote.css')); ?>">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            <li>
              <a style="padding:8px 8px 8px 0px;" title="Sign Out" class="dropdown-item" href="<?php echo e(route('logout')); ?>"
...
echo "Usage: " . $MB . " MB \n";?>
    ...
    <script src="<?php echo e(asset('/assets/bower_components/datatables.net/js/dataTables.buttons.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('/assets/bower_components/summernote/summernote.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>