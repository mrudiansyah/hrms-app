			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<h3 class="box-title">Archieve Overtime Request <small>(Tanggal < <?php echo e($data['today']); ?>)</small></h3>
						<div class="box-tools pull-right">
							<a class="btn btn-default btn-md" href="/GeneralMemo/<?php echo e($data['category']); ?>">
								<i class="fa fa-file-o"></i> &nbsp;New Memo
							</a>
							<a class="btn btn-default btn-md" href="/ArchieveMemoDetail/<?php echo e($data['category']); ?>/<?php echo e($data['periode']); ?>">
...
<?php $__env->startSection('Scripts'); ?>
	...
	<script>
		$('body').on("change","#periode",function(){
			...
			window.location.href="<?php echo e($site); ?>/ArchieveMemo/"+kategori+"/"+periode;
		});
	</script>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/general_memo/memo_archieve.blade.php ENDPATH**/ ?>