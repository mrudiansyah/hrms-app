								...
								<tr>
									...
									<td>
										...
										<div class="pull-right">
											<a href="/ESS/Document/Download/{{$dt->id_doc}}" title="Download" type="button" class="btn btn-info btn-xs"><i class="fa fa-download"></i></a>
										</div>
									</td>
								</tr>
								@endforeach
			...
			<div class="col-lg-7 col-md-12 col-xs-12">
				<div class="box box-success" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<a href="/Training/Actual/{{$id_training}}" id="savechange"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-floppy-o"></i> &nbsp;Save Change</button></a>
							@if($in_class==1)
							...
							<thead>
								<tr>
									...
									<th>
										Free Test
										<div class="box-tools pull-right">
											<a href="/Training/Monitor/Free/{{$id_training}}" title="Monitoring" type="button" class="btn btn-primary btn-xs"><i class="fa fa-tv"></i></a>
										</div>
									</th>
									<th>
										Post Test
										<div class="box-tools pull-right">
											<a href="/Training/Monitor/Post/{{$id_training}}" title="Monitoring" type="button" class="btn btn-primary btn-xs"><i class="fa fa-tv"></i></a>
										</div>
									</th>
								</tr>
							</thead>
