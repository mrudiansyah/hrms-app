				...
				<form role="form" action="/PolicyLevel/Save" method="post">
					...
					<div class="box box-success" style="background:#FFF;">
						<div class="box-header">
							...
							<h3 class="box-title">{{$data['policy_name']}}</h3>
							<input type="hidden" id="id_policy" name="id_policy" value="{{$data['id_policy']}}">
						</div>
						<div class="box-body">
							<table id="table1" class="table table-hover">
									...
									<tr>
										...
										<td>
											<div class="checkbox-item">
												<input type="hidden" name="id_level_{{$no}}" value="{{$dt->id_level}}">
												<input type="checkbox" class="status" id="status_{{$no}}" name="status_{{$no}}" value="1" <?php if($dt->status==1){$qty_status++;echo "checked";}?>>
												<label for="id_tabel2_{{$no}}">{{$dt->nama_level}}</label>
											</div>
										</td>
										<td>{{$dt->updated_by}}</td>
										<td>{{$dt->updated_at}}</td>
								...
								<tfoot>
									<tr>
										<td></td>
										<td>
											<input type="hidden" id="qty_status" value="{{$qty_status}}">
											<input type="hidden" id="qty_all" value="{{$no}}">
						...
						<div class="box-footer">
							<input type="hidden" id="qty" name="qty" value="{{$no}}">
