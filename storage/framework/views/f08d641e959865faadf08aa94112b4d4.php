	...
	<div class="content-wrapper">
		...
		<div class="box box-primary">
			...
			<div class="box-header with-border">
				<label>Preview SPL: <?php echo e($dt->id_overtime); ?></label>
			...
			<div style="padding:15px;background:#FFF;overflow-x: scroll;">
					...
					<tr>
						<td style="border:1px solid #000;padding:10px 5px;">
							<table style="width:100%;" class="tabeljudul">
								<tr>
									<td style="width:240px;"><img src="<?php echo e(asset('public/gambar/logosai.png')); ?>" style="width:180px;"></td>
					...
					<tr>
						<td style="font-size:12px;border:0px solid #000;padding:0px;font-weight: normal">
							<table style="width:100%;" cellspacing="0" class="tabelot">
								...
								?>
								<tr id="R<?php echo e($no); ?>">
									<td id="C1B<?php echo e($no); ?>">
										<?php echo e($no); ?>

									</td>
									<td id="C2B<?php echo e($no); ?>" style="text-align:left;"><?php echo e($dt2->employee_name); ?></td>
									<td id="C3B<?php echo e($no); ?>"><?php echo e($dt2->NIK); ?></td>
									<td id="C4B<?php echo e($no); ?>"><?php echo e($dt->dept_name); ?></td>
									<td>
										<?php if($dt2->pic_or_subtitusi=="Subtitusi"): ?>
											<label class="label label-danger"><?php echo e($dt2->pic_or_subtitusi); ?></label>
											<?php $subtitusi++;?>
										<?php elseif($dt2->pic_or_subtitusi=="PIC"): ?>
											<label class="label label-success">Original</label>
										<?php endif; ?>
									</td>
									<td>
										<?php echo e($dt2->reason); ?>
									...
									<td>
										...
										?>
										<input type="hidden" id="satuan<?php echo e($no); ?>" value="<?php echo e($dt2->status); ?>">
										<?php 
											...
											<button title="Yes" id="yes-dip<?php echo e($no); ?>" type="button" class="btn btn-success btn-xs yes-dip" data-nilai="<?php echo e($no); ?>" data-detailid="<?php echo e($dt2->id); ?>"><i class="fa fa-check"></i></button>
											<button title="No" id="no-dip<?php echo e($no); ?>" type="button" class="btn btn-danger btn-xs no-dip" data-nilai="<?php echo e($no); ?>" data-detailid="<?php echo e($dt2->id); ?>"><i class="fa fa-close"></i></button>
								...
								<tr>
									...
									<td style="border-left:0px;border-right:0px;"><input type="text" value="<?php echo e($no); ?>" style="width:50px;height:20px;font-size:16px;text-align:center;"></td>
									...
									<td>
										<input type="hidden" id="statusapproval" value="<?php echo e($posisi_approval); ?>">
										<input type="hidden" id="jumlahno" value="<?php echo e($no); ?>">
									</td>
								</tr>
								<tr>
										...
										<table style="width:100%;" class="tabeljudul">
											...
											<tr>
												...
												<td>
													...
													<b><?php echo e($paid); ?></b><br>(<?php echo e($paid_j); ?>)
												</td>
											</tr>
										</table>
									</td>
				...
				<div style="font-size:11px;border:0px;padding:5px;">
					<input type="hidden" id="subtitusi" value="<?php echo e($subtitusi); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/approvalspl.blade.php ENDPATH**/ ?>