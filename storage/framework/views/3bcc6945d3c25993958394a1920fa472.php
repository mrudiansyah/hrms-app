						...
						<div class="box-body" style="min-height:200px;overflow-x:scroll;">
							<div id="tabels">
								...
								<table id="tables" class="table table-striped" border="0">
									...
									<tbody>
									<?php $no=0;?>
										<?php $__currentLoopData = $tb_permit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td>
												...
												<div class="pull-right">
													<?php if($dt->bukti!=''): ?>
													<!-- <a href="/Show/<?php echo e($dt->bukti); ?>" title="Preview" type="button" class="btn btn-primary btn-xs" target="_balnk"><i class="fa fa-image"></i></a> -->
													<?php endif; ?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_permit\permit_report.blade.php ENDPATH**/ ?>