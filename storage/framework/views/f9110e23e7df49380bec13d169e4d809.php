					...
					<div class="box-body">
						<div class="pull-right">
							...
							<select id="category" class="form-control pilihan">
								...
								?>
								<?php $__currentLoopData = $tb_skill_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<select id="category2" class="form-control pilihan">
								...
								<?php $__currentLoopData = $tb_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($dt->category!=$category): ?>
						...
						<table id="tables" class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<!-- <td><?php echo e($dt->id_competence_list); ?></td> -->
									<td><?php echo e($dt->category); ?></td>
									<!-- <td><?php echo e($dt->level_participant); ?></td> -->
									<td>
										<div class="pull-right">
											<button title="Edit" type="button" class="form btn btn-primary btn-xs" data-idtraininglist="<?php echo e($dt->id); ?>" data-trainingname="<?php echo e($dt->training_name); ?>" data-idtype="<?php echo e($dt->id_type); ?>" data-categorytraining="<?php echo e($dt->category); ?>" data-levelparticipant="<?php echo e($dt->level_participant); ?>"><i class="fa fa-edit"></i></button>
						...
						<div class="modal-body">
							...
							<div class="form-group opsiedit">
								...
								<select id="skilltype" class="form-control">
									<option value=""></option>
									<?php $__currentLoopData = $tb_skill_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($dt->id); ?>"><?php echo e($dt->skill_type); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/training/training_list.blade.php ENDPATH**/ ?>