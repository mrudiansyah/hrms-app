                ...
                <div class="card-body">
                    <form id="loginForm">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" class="form-control" value="{{ config('hcmis.username') }}">
                        </div>
                        <div class="form-group">
                            <label for="password">Password</label>
                            <input type="password" id="password" class="form-control" value="{{ config('hcmis.password') }}">
                        </div>
