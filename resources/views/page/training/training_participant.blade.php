		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box box-primary" style="background:#FFF;">
				...
				<div class="box-header">
					...
					<div class="box-tools pull-right">
						<div class="box-tools">
							<a href="/FreeTest/{{$id_participant}}" <?php if($data['pre_test']!='')echo "disabled";?> title="Free Test" type="button" class="btn btn-primary btn-xs">Start Pre Test</a>
						</div>
					</div>
				</div>
				<div class="box-body">
								...
								<td>
									...
									<div class="pull-right">
										...
										if($extensi=='.mp4'||$extensi=='.pdf'||$extensi=='pptx'){?>
											{{-- <a href="/Training/Actual/{{$id_training}}/{{$dt->id_doc}}" title="Preview" type="button" class="btn btn-primary btn-xs"><i class="fa fa-tv"></i></a> --}}
											<button class="btn btn-primary btn-xs" id="preview" onclick="GetPreview({{ $dt->id_doc }})">Lihat Materi</button>
										<?php }?>
										<!-- 
				...
				<div class="box-header">
					...
					<div class="box-tools pull-right">
						<div class="box-tools">
							<a href="/PostTest/{{$id_participant}}" <?php if(($data['pre_test']==''||$data['post_test']!='')&&$data['grade_status']==1)echo "disabled";?> title="Post Test" type="button" class="btn btn-primary btn-xs">Start Post Test</a>
						</div>
					</div>
				</div>
						...
						<tbody id="konten">
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" name="post_test" id="post_test" value="{{ $dt->post_test }}">
									<?php 
