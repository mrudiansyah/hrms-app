				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<a href='/Status/KSK/Detail/<?php echo e($id_ksk); ?>/<?php echo e($periode); ?>'><button type="button" class="btn btn-default btn-xs"><i class="fa fa-backward"></i> &nbsp;BACK</button></a>
							<?php if($id_ksk>0): ?>
							...
							<?php else: ?>
								...
								<!-- <a href='/Status/KSK/Import/<?php echo e($periode); ?>'>
						...
						<table id="table2" class="table table-hover tabel2">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($dt->warning_letter); ?></td>
					...
					<form method="post" action="/Status/KSK/Import" enctype="multipart/form-data">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="hidden" value="<?php echo e($periode); ?>" name="periode">
							</div>
						</div>
						<div class="modal-footer">
							<a href="/Status/KSK/Template/<?php echo e($periode); ?>" id="template" target="_blank" class="btn btn-default btn-md"><i class="fa fa-download"></i> &nbsp;Template</a>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_employee/ksk_detail_performance.blade.php ENDPATH**/ ?>