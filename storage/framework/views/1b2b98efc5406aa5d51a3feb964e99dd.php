            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <form action="<?php echo e(url('/payroll/summary_overtime')); ?>" method="GET" class="form-inline" style="display: inline-block;">
                            ...
                            <form action="<?php echo e(url('/payroll/save_summary')); ?>" method="POST" style="display: inline-block; margin-left: 10px;">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $tb1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(number_format($item->hours_convertion, 2)); ?></td>
                                                <td><?php echo e(number_format($item->total_overtime, 0, ',', '.')); ?></td>
                                                <td><?php echo e(number_format($item->total_meal, 0, ',', '.')); ?></td>
                                                <td><?php echo e(number_format($item->total_bayar, 0, ',', '.')); ?></td>
                                            </tr>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\payroll\summary_overtime.blade.php ENDPATH**/ ?>