<aside class="main-sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			<?php if (request()->user()->hasRole('candidate')) {?>
				<li><a href="/HRMS/candidate"><i class="fa fa-user"></i> Candidate</a></li>
			<?php }?>
				...
				<li class="treeview<?php if(isset($menu)&&($menu=='user_management'))echo ' active';?>">
					...
					<ul class="treeview-menu">
						@if(request()->user()->hasRole('add_user'))
							<li><a href="/HRMS/user-management"><i class="fa fa-user"></i> Users</a></li>
						@endif
						@if(request()->user()->hasRole('role'))
							<li><a href="/HRMS/role-management"><i class="fa fa-key"></i> Roles</a></li>
							<li><a href="/HRMS/userrole-management"><i class="fa fa-cogs"></i> User Role</a></li>
						@endif
					</ul>
				</li>
			<?php }?>
				...
				<li class="treeview<?php if(isset($menu)&&($menu=='overtime'||$menu=='overtime_summary'||$menu=='overtime_tax'||$menu=='capture_assignment'||$menu=='summary_assignment'))echo ' active';?>">
					...
					<ul class="treeview-menu">
						<li class="treeview<?php if(isset($menu)&&($menu=='overtime_summary'||$menu=='overtime_tax'))echo ' active';?>">
							...
							<ul class="treeview-menu">
								<li><a href="/HRMS/payroll/summary_overtime/0/0"><i class="fa fa-circle"></i> Capture</a></li>
								<li><a href="/HRMS/payroll/tax_overtime/0/0"><i class="fa fa-circle"></i> Summary</a></li>
							</ul>
						</li>
						<li class="treeview<?php if(isset($menu)&&($menu=='capture_assignment'||$menu=='summary_assignment'))echo ' active';?>">
							...
							<ul class="treeview-menu">
								<li><a href="/HRMS/payroll/capture_assignment/0/0"><i class="fa fa-circle"></i> Capture</a></li>
								<li><a href="/HRMS/payroll/summary_assignment/0/0"><i class="fa fa-circle"></i> Summary</a></li>
							</ul>
						</li>
					</ul>
				</li>
				...
				<li class="treeview<?php if(isset($menu)&&($menu=='manifest'||$menu=='master_ap'||$menu=='master_area'||$menu=='working_area'||$menu=='outside'||$menu=='scurity'))echo ' active';?>">
					...
					<ul class="treeview-menu">
						<li class="treeview<?php if(isset($menu)&&($menu=='master_ap'||$menu=='master_area'||$menu=='working_area'))echo ' active';?>">
							...
							<ul class="treeview-menu">
								<li><a href="/HRMS/master_ap"><i class="fa fa-users"></i> Assembly Point</a></li>
								<li><a href="/HRMS/master_area"><i class="fa fa-map-marker"></i> Data Area</a></li>
								<li><a href="/HRMS/working_area"><i class="fa fa-street-view"></i> Employee Area</a></li>
							</ul>
						</li>
						<li><a href="/HRMS/outside"><i class="fa fa-car text-orange"></i> Outside Assigment</a></li>
						<li class="treeview<?php if(isset($menu)&&($menu=='scurity'))echo ' active';?>">
							...
							<ul class="treeview-menu">
								<li><a href="/HRMS/scurity/assigment"><i class="fa fa-file-text-o"></i> Tugas Luar</a></li>
								<li><a href="/HRMS/scurity/permit"><i class="fa fa-file-text"></i> Form Ijin</a></li>
							</ul>
						</li>
						<li><a href="/HRMS/manifest"><i class="fa fa-list-alt text-orange"></i> Verify Manifest</a></li>
					</ul>
				</li>
			<?php }?>
