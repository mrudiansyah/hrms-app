                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?php echo e(route('renewal.index')); ?>" class="btn btn-default btn-sm">
                                    <i class="fa fa-arrow-left"></i> Back
                                </a>
                            </div>
                        </div>
                        <form action="<?php echo e(route('renewal.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="box-body">
                                <!-- Data Karyawan -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nik" class="form-control"
                                                        value="<?php echo e(old('nik', $employeeData->nik ?? '')); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control"
                                                        value="<?php echo e(old('name', $employeeData->name ?? '')); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date_of_join" class="form-control"
                                                        value="<?php echo e(old('date_of_join', $employeeData->date_of_join ?? '')); ?>"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="work_period" class="form-control"
                                                        value="<?php echo e(old('work_period', $employeeData->work_period ?? '')); ?>"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_position" class="form-control"
                                                        value="<?php echo e(old('last_position', $employeeData->position ?? '')); ?>"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_division" class="form-control"
                                                        value="<?php echo e(old('last_division', $employeeData->department_id ?? '')); ?>"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="category" id="category" class="form-control" required>
                                                        ...
                                                        <option value="Promotion" <?php echo e(old('category') == 'Promotion' ? 'selected' : ''); ?>>Promotion (Kenaikan Pangkat/Gaji)</option>
                                                        <option value="Mutation" <?php echo e(old('category') == 'Mutation' ? 'selected' : ''); ?>>Mutation (Mutasi)</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="new_position" class="form-control" required>
                                                        ...
                                                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($position->position_name); ?>" <?php echo e(old('new_position') == $position->position_name ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="new_grade" class="form-control"
                                                        value="<?php echo e(old('new_grade')); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="new_division" class="form-control"
                                                        value="<?php echo e(old('new_division')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="new_salary" id="new_salary" class="form-control currency"
                                                        value="<?php echo e(old('new_salary')); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="new_others" id="new_others" class="form-control"
                                                        value="<?php echo e(old('new_others')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="reasons" class="form-control" rows="4"
                                                        required><?php echo e(old('reasons')); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="effective_from" class="form-control"
                                                        value="<?php echo e(old('effective_from', date('Y-m-d'))); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="suggested_by_id" id="suggested_by_id" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($emp->id); ?>"><?php echo e($emp->NIK); ?> - <?php echo e($emp->employee_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo e(route('renewal.index')); ?>" class="btn btn-default">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\renewal\form.blade.php ENDPATH**/ ?>