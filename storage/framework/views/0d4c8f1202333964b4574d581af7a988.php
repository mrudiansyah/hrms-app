<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="<?php echo e(asset('/public/assets/dist/img/user.jpg')); ?>" class="img-circle" alt="User Image"
        ...
        echo ' active';?>">
            ...
            <?php if(isset($ess_leave) && $ess_leave == 1): ?>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/layouts/menu_ess.blade.php ENDPATH**/ ?>