...
<?php $__currentLoopData = $tb_slip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php 
            $pendapatan = $dt->Upah_Pokok + $dt->Tunjangan_Jabatan + $dt->Tunjangan_Prestasi + $dt->Tunjangan_Skill + $dt->Rapel + $dt->PPH21_Insentif + $dt->PPH21_Lebih_Bayar + $dt->tunjangan_shift + $dt->tunjangan_transport;
    ...
    <table style="width:100%;" cellspacing="0">
        <tr>
            <td class="bingkai" style="padding:7px;">
                <table style="width:100%;" cellspacing="0">
                    <tr>
                        <td style="width:120px;"><img src="<?php echo e(base_path()); ?>/public/gambar/logosai.png" style="width:100%;">
                        </td>
            ...
            <td class="bingkai">
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style="text-align:center;width:50%;">Diterima oleh,<br><br><br><br><?php echo e($dt->Nama); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
</script><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page_ess\slip_gaji_magang.blade.php ENDPATH**/ ?>