...
<head>
    ...
    <title>{{ config('app.name', 'EMS') }} - Login</title>
        ...
        <div class="glass-panel">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="NIK / Email" required autocomplete="email" autofocus>
