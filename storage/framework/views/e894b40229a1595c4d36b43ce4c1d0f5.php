                    ...
                    <div class="box box-success" style="border:0px;">
                        ...
                        <h3 class="box-title">Overtime vs Sales</h3>
                            <div class="box-tools pull-right">
                                <button title="Edit Sales" type="button" class="sales-modal btn btn-info btn-xs" data-periodesales="<?php echo e($periode); ?>" data-salesammount="<?php echo e($salesammount); ?>"><i class="fa fa-wrench"></i> Sales: <?php echo number_format($salesammount,0);?></button>
                                <a href="/Grafik/<?php echo e($periode); ?>/1" type="button" class="btn btn-primary btn-xs"><i class="fa fa-refresh"></i>&nbsp; Pareto <?php echo e($periode); ?></a>
                            </div>
                        </div>
						...
						<div class="box-body" style="min-height:200px;overflow-x: scroll;">
							<div id="tabel2">
								<table id="table2" class="table table-striped" border="0">
									...
									<tbody>
									<?php $no=0;?>
									<?php $__currentLoopData = $tb_overtime_plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php 
												...
												<div class="pull-right">
													<?php if($dt->autoCancel==0){?>
														...
														<?php if($submenu=='verification'&&$dt->status_approve=='0')echo '&nbsp;';else{?>
															<a title="Show" href='<?php echo e($tujuan); ?><?php echo e($dt->id); ?>'<?php if(isset($id_employee)&&($id_employee=='122'||$id_employee=='101'))echo " target='_blank'";?>><button type="button" class="btn btn-primary btn-xs" id="d<?php echo e($no); ?>" onclick="<?php echo "myFunction(".$no.");"?>"><i class="fa fa-edit"></i></button></a>
														<?php }?>
													<?php }else{?>
														<?php if (isset($status_lock)&&request()->user()->hasRole('hr_access')&&$status_lock==0) {?>
															<button title="Open" type="button" class="open-modal btn btn-success btn-xs" data-openid="<?php echo e($dt->id); ?>" data-openname="<?php echo e($dt->id_overtime); ?>"><i class="fa fa-refresh"></i></button>
														<?php }else{?>
															<button class="btn btn-default btn-xs" onclick="alert('SPL ini sudah lebih dari 24 Jam sejak dibuat <?php echo e($dt->created_at); ?>');"><i class="fa fa-info-circle" title="Created_at <?php echo e($dt->created_at); ?>"></i></button>
														<?php }?>
													<?php }?>
													<a title="Print" href='/Admin/Overtime/Preview/<?php echo e($dt->id); ?>' target="_blank"><button type="button" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></button></a>
												</div>
											</td>
							...
							<?php if($submenu=='realisation'){?>
								<div id="tabel3">
									<table id="table3" class="table table-striped" border="0">
										...
										<tbody>
										<?php $no=0;?>
										<?php $__currentLoopData = $tb_overtime_actual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php 
												if($submenu=='approval')$tujuan="/Admin/Overtime/Approval/";
												if($submenu=='realisation')$tujuan="/Admin/Overtime/Dept/";
												if($submenu=='verification')$tujuan="/Admin/Overtime/Verification/";
													...
													<div class="pull-right">
														<?php if($dt->autoCancel==0){?>
															<?php if($submenu=="realisation"&&$dt->status_diperintah=='0'){?>
																<a title="Show" href='/Admin/Overtime/Draft/<?php echo $dt->id;?>'><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-refresh"></i></button></a>
															<?php }?>
															<a title="Show" href='<?php echo e($tujuan); ?><?php echo e($dt->id); ?>'><button type="button" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></button></a>
														<?php }?>
														<a title="Print" href='/Admin/Overtime/Preview/<?php echo e($dt->id); ?>' target="_blank"><button type="button" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></button></a>
													</div>
												</td>
							...
							<div id="tabel4">
								<div class="row" style="padding-bottom:20px;">
									<div class="col-lg-2 col-md-3 col-xs-12">
										...
										<input type="hidden" class="form-control" id="cabang" value="<?php echo e($cabang); ?>">
									</div>
								</div>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/createdspl.blade.php ENDPATH**/ ?>