        ...
        <tbody>
            ...
            <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td><?php echo e($uang_lembur || $uang_makan_ot ? number_format($uang_makan_ot, 0, '.', ',') : ($ot ? '0' : '')); ?>

                    </td>
                    <td><?php echo e($uang_lembur || $uang_makan_tl ? number_format($uang_makan_tl, 0, '.', ',') : ($ot ? '0' : '')); ?>
            ...
            <tr>
                ...
                <td><?php echo e(number_format($grand_total_bayar + ($summary->rapel_amount ?? 0), 0, '.', ',')); ?></td>
            </tr>
        </tbody>
    </table>
                ...
                <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                    <table class="bottom-right" style="width:200px;" align="right">
                        ...
                        <tr>
                            ...
                            <td class="val">
                                <strong><?php echo e(number_format(($grand_total_bayar + ($summary->rapel_amount ?? 0)) - ($summary->pph21_amount ?? 0), 0, '.', ',')); ?></strong>
                            </td>
                        </tr>
                    </table>
                </td>
...
</html><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page_ess\slip_assignment.blade.php ENDPATH**/ ?>