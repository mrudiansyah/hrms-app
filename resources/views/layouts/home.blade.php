...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('/public/assets/bower_components/fullcalendar/dist/fullcalendar.print.min.css') }}"
        media="print">
    <style>
        .fc-time {
            display: none;
    ...
    <!-- <link rel="shortcut icon" href="{{ asset('public/gambar/ems.png') }}"> -->
...
echo "Usage: " . $MB . " MB \n";?>
        ...
        <!-- DataTables -->
        <script
            src="{{ asset('/public/assets/bower_components/datatables.net/js/jquery.dataTables.min.js') }}"></script>
        <script
            src="{{ asset('/public/assets/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
        <!-- SlimScroll -->
        <script
            src="{{ asset('/public/assets/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
        <!-- FastClick -->
        ...
        <script
            src="{{ asset('/public/assets/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
        <script
        ...
        <script
            src="{{ asset('/public/assets/bower_components/datatables.net/js/dataTables.buttons.min.js') }}"></script>
        ...
        <!-- Sparkline -->
        <script
            src="{{ asset('/public/assets/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
        <!-- jvectormap -->
        ...
        <!-- Bootstrap WYSIHTML5 -->
        <script
            src="{{ asset('/public/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
