				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							...
							<button class="btn btn-default btn-md" onclick="window.location.href='/Policy'">
								...
								<tr>
									...
									<td>
										...
										@if(request()->user()->hasRole('hr_access'))
											<button class="btn btn-success btn-xs reactive" data-id="{{$dt->id}}">
