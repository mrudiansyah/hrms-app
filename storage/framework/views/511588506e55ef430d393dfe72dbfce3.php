					...
					<div class="box-header">
						...
						<div class="pull-right">
							...
							<?php }else{?>
								...
								<a href="/Status/NonActive/<?php echo e($periode); ?>" class="btn btn-app">
									<i class="fa fa-user-times"></i> Non Active
								</a>
								<a href="/Status/Arsif/<?php echo e($periode); ?>" class="btn btn-app">
					...
					<div class="box-body" style="overflow-x:scroll;">
						<div class="row">
							...
							<div class="col-xs-12 col-md-3 col-lg-2">
								<input class="form-control" type="month" id="periode" name="periode" value="<?php echo e($periode); ?>">
							</div>
						</div><br>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_employee/contract_inactive.blade.php ENDPATH**/ ?>