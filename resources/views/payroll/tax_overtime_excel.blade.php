                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="pull-right">
                                <a href="{{ url('/payroll/tax_overtime/' . $start . '/' . $end) }}"
                                    class="btn btn-default btn-md"><i class="fa fa-angle-double-left"></i> &nbsp;Back</a>
                                <a href="/payroll/tax_overtime_approval/Overtime/{{$periode}}"
                                    class="btn btn-info btn-md"><i class="fa fa-edit"></i> &nbsp;Add Approval</a>
                                <button class="btn btn-success btn-md"
                                    onclick="exportTableToExcel('payroll-table', 'Overtime_Summary_{{$periode}}')"><i
                                        class="fa fa-file-excel-o"></i>
                                    &nbsp;Save as Excel</button>
                                <a href="/payroll/tax_overtime_pdf/{{$start}}/{{$end}}" class="btn btn-danger btn-md"
