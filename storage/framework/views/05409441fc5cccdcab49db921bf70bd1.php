...
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
				...
				<div class="box box-success" style="border:0px;">
					...
					<h3 class="box-title" id="ovtitle">Overtime vs Sales</h3>
						<div class="box-tools pull-right" id="btn-canvas">
							<button title="Edit Sales" type="button" id="salesammount" class="sales-modal btn btn-info btn-xs" data-periodesales="<?php echo e($periode); ?>" data-salesammount="<?php echo e($salesammount); ?>"><i class="fa fa-wrench"></i> Sales: <?php echo number_format($salesammount,0);?></button>
							<a href="javascript:void(0)" id="paretto" type="button" class="btn btn-primary btn-xs" onclick=""><i class="fa fa-refresh"></i>&nbsp; Pareto <?php echo e($periode); ?></a>
						</div>
				...
				<div class="box box-primary" style="background:#FFF;">
					<div class="box-header">
						...
						<div class="pull-right">
                            ...
                            <a  class="btn btn-app" href="<?php echo e(route('ApproveSPLAll')); ?>">
	...
	<script src="<?php echo e(asset('/public/assets/bower_components/jquery/dist/jquery.min.js')); ?>"></script>
<?php $__env->startSection('Scripts'); ?>
	<script>
		...
		var tablePlan = $("#table2").DataTable({
			...
			ajax: {
				type: 'POST',
				url: "<?php echo e(route('ApprovalSPL.GetDataPlanApproval')); ?>",
				data: function(d) {
	...
	function GetParetto(paretto,periode){
		...
		x = x = $.ajax({
		type: "POST",
		url: "<?php echo e(route('ApprovalSPL.ChartApproval')); ?>",
		data: t,
...
//#region Completed SPL
	function GetCompleteApproval(){
		...
		var table = $("#completeTable").DataTable({
			...
			ajax: {
				type: 'POST',
				url: "<?php echo e(route('ApprovalSPL.GetDataCompleteApproval')); ?>",
				data: function(d) {
					d._token = document.querySelector('meta[name="csrf-token"]')
						.getAttribute('content');
	...
	function GetSalesAmmount(){  
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('ApprovalSPL.GetSalesAmmount')); ?>",
			data: data,
			dataType: "json",
			success: function (data) {
				// console.log(data);
	...
	function simpan() {  
			...
			$.ajax({
				type: "POST",
				url: "<?php echo e(route('ApprovalSPL.updateSales')); ?>",
				data: string,
				dataType: "json",
				success: function (data) {
					if(data.success == 1){
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/approvalspl_fixed.blade.php ENDPATH**/ ?>