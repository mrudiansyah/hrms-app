					...
					<div class="box box-primary" style="background:#FFF;">
						<div class="box-header">
							...
							<div class="pull-right">
								<input type="hidden" id="limit_status" value="<?php echo e($limit_leave_status); ?>">
									...
									<?php $no=0;$nik='';$punya=0;$siap=0;$belum=0;$combine='';$qty=0;?>
										...
										<tr <?php if($dt->end<$now)echo "style:background:FF0;";?>>
											...
											<td>
												...
												<div class="pull-right">
													<?php if((request()->user()->hasRole('root')||request()->user()->hasRole('hr_access'))&&$dt->outstanding<=0): ?>
														<a href="/Leave/Create/<?php echo e($dt->id); ?>"><button title="Create New" type="button" class="btn btn-warning btn-xs"><i class="fa fa-file-o"></i></button></a>
													<?php endif; ?>
													<?php if(request()->user()->hasRole('allowance')){?>
														<?php if($nik==$dt->NIK){?>
															<a href="/Leave/Employee/Delete/<?php echo e($dt->id); ?>"><button title="Delete" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
														<?php }?>
										...
										<tfoot>
											<tr>
												...
												<td colspan="3" style="text-align:center;">
													Under 1 Year : <span class="label label-danger"><?php echo e($belum); ?></span>
												</td>
												<td colspan="4" style="text-align:center;">
													Need Activation : <span class="label label-info"><?php echo e($siap); ?></span>
												</td>
												<td colspan="5" style="text-align:center;">
													Activated Form : <span class="label label-success"><?php echo e($punya); ?></span>
												</td>
											</tr>
										</tfoot>
								</table>
...
<?php $__env->startSection('Scripts'); ?>
	...
	// 		$.ajax({
	// 			type: "POST",
	// 			url: "<?php echo e(route('/Leave/AutoCreateCuti')); ?>",
	// 			data: data,
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_leave\leave.blade.php ENDPATH**/ ?>