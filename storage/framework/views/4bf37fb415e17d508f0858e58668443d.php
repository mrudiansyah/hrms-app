					...
					<div class="box-header">
						...
						<div class="box-tools pull-right">
							<?php if($leader_status=='1'){?>
								<a href='/Status/KSK/Create/<?php echo e($periode); ?>'><button type="button" class="btn btn-primary btn-xs">FORM KSK &nbsp;<i class="fa fa-forward"></i></button></a>
					...
					<div class="box-body" style="overflow-x:scroll;">
						<div class="box-header" style="padding-left:0px;padding-bottom:30px;">
							<div class="box-tools pull-left">
								Select Periode<input type="month" class="form-control" id="periode" name="periode" value="<?php echo e($periode); ?>">
							</div>
						</div>
							...
							<tbody>
								...
								<tr style="<?php if($dt->finish_contract<=$sekarang)echo "background:yellow;";?>">
									<td>
										...
										?>
										<!-- 
										<button type="button" class="btn btn-primary btn-xs updatekontrak-modal" data-action='New' data-idcontract='<?php echo $dt->id;?>' data-idemployee='<?php echo $dt->idemployee;?>' data-nmemployee='<?php echo e($dt->employee_name); ?>' data-joindate='<?php echo e($dt->joindate); ?>' data-tglawal='<?php echo e($PeriodeAwal); ?>' data-statusawal='<?php echo e($dt->contract_name); ?>'><i class="fa fa-edit"></i></button>
										-->
									...
									<td>
										<?php if($dt->leader1==''){?>
											<div class="pull-right">
												<button type="button" class="btn btn-primary btn-xs update-modal" data-idemployee='<?php echo e($dt->idemployee); ?>' data-nmemployee='<?php echo e($dt->employee_name); ?>'><i class="fa fa-edit"></i></button>
											</div>
										<?php }elseif($dt->leader2==''){?>
											<?php echo e($dt->leader1); ?>

											<div class="pull-right">
												<button type="button" class="btn btn-primary btn-xs update-modal" data-idemployee='<?php echo e($dt->id_leader1); ?>' data-nmemployee='<?php echo e($dt->leader1); ?>'><i class="fa fa-edit"></i></button>
											</div>
										<?php }elseif($dt->leader3==''){?>
											<?php echo e($dt->leader2); ?>

											<div class="pull-right">
												<button type="button" class="btn btn-primary btn-xs update-modal" data-idemployee='<?php echo e($dt->id_leader2); ?>' data-nmemployee='<?php echo e($dt->leader2); ?>'><i class="fa fa-edit"></i></button>
											</div>
										<?php }else{
				...
				<div class="modal-body">
					...
					<div class="form-group">
							...
							<select name="id_leader" class="form-control selectpicker" data-live-search="true">
								<option value=""></option>
								<?php $__currentLoopData = $tb_leader; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_employee/ksk_draft.blade.php ENDPATH**/ ?>