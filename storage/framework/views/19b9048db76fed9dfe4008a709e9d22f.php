            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-4">
                    <?php $__currentLoopData = $tb_overtime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <input type="hidden" name="deptid" id="deptid" value="<?php echo e($dept_id); ?>">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <label>SPL: <?php echo e($dt->id_overtime); ?></label>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input id="idot" type="hidden" value="<?php echo e($dt->id); ?>" name="idot" class="form-control">
                                    <input id="idovertime" type="hidden" value="<?php echo e($dt->id_overtime); ?>" name="id_overtime" class="form-control">
                                    <input id="dateon" type="hidden" value="<?php echo e($dt->ot_date); ?>" name="date_on" class="form-control">
                                    <input id="dateonshow" type="text" value="<?php echo e($dt->ot_date); ?>" class="form-control" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="idemployee" name="id_employee" class="form-control selectpicker" data-live-search="true">
                                        ...
                                        <?php $__currentLoopData = $tb_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dt2->id); ?>"> <?php echo e($dt2->employee_name); ?> 
                                                (<?php echo e($dt2->NIK); ?> - <?php echo e($dt2->dept_code); ?>)
                                            </option>
                                ...
                                <div class="form-group khusus">
                                    ...
                                    <select name="job_ot" id="jobot" class="form-control">
                                        <option></option>
                                        <?php $__currentLoopData = $tb_job_ot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dt2->job_ot); ?>"><?php echo e($dt2->job_ot); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="form-group khusus">
                                    ...
                                    <select name="customer" id="customer" class="form-control">
                                        <option></option>
                                        <?php $__currentLoopData = $tb_customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($dt2->customer_code); ?>"><?php echo e($dt2->customer_code); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="start_plan" class="form-control" id="startplan" min="<?php echo e($MinBottom); ?>" max="<?php echo e($MaxTop); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Plan Finish</label>
                                    <input type="datetime-local" name="finish_plan" class="form-control" id="finishplan" min="<?php echo e($MinBottom); ?>" max="<?php echo e($MaxTop); ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="box-footer">
                                <div class="row" style="padding:20px;">
                                    <form action="/Admin/Overtime/Note" method="post">
                                        ...
                                        <input type="hidden" name="id_ot" value="<?php echo e($idSPL); ?>">
                                        <div class="form-group">
                                            <label>Notes:</label>
                                            <?php $__currentLoopData = $tb_pesan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row" style="padding:5px 20px;">
                                                    <u style="color:#CCC;"><?php echo e($row->penulis); ?> <?php echo e($row->waktu); ?> :</u>
                                ...
                                <div class="form-group">
                                    <a href="/Admin/Overtime/Confirm/<?php echo e($idSPL); ?>"><button type="button"
                                            class="btn btn-warning confirm-btn">Confirm</button></a>
                                    <a href="/Admin/Overtime/Preview/<?php echo e($idSPL); ?>" target="_blank"><button
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#line").select2({
                ...
                ajax: {
                    url: "<?php echo e(route('Admin.Overtime.GetListLine')); ?>",
                    type: "post",
                    dataType: 'json',
                    quietMillis: 250,
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/formspl_detail.blade.php ENDPATH**/ ?>