            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <form action="<?php echo e(url('/payroll/tax_overtime')); ?>" method="GET" class="form-inline"
                            ...
                            <form action="<?php echo e(url('/payroll/tax_overtime/calculation')); ?>" method="POST"
                                style="display: inline-block;">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="start" value="<?php echo e($start); ?>">
                                <input type="hidden" name="end" value="<?php echo e($end); ?>">
                            ...
                            <a href="<?php echo e(url('/payroll/tax_overtime_excel/' . $start . '/' . $end)); ?>"
                                class="btn btn-success btn-md" style="margin-left: 5px;"><i class="fa fa-file-excel-o"></i>
                                &nbsp;Excel</a>
                            <a href="<?php echo e(url('/payroll/distribute_spl_slip/' . $start . '/' . $end)); ?>"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $tb1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo e(number_format($item->rapel_amount, 0)); ?>

                                                    <button type="button"
                                                        class="btn btn-xs btn-warning btn-detail-overtime pull-right"
                                                        data-id="<?php echo e($item->id); ?>" data-id-employee="<?php echo e($item->id_employee); ?>"
                                                        data-employee-name="<?php echo e($item->employee_name); ?>" title="Detail Overtime">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn-detail-overtime', function () {
                ...
                $.ajax({
                    url: '<?php echo e(url("/payroll/overtime_detail")); ?>',
                    type: 'GET',
                    data: {
                        id: id,
            ...
            $(document).on('click', '.btn-capture-rapel', function () {
                ...
                $.ajax({
                    url: '<?php echo e(url("/payroll/capture_rapel")); ?>',
                    type: 'POST',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/payroll/tax_overtime.blade.php ENDPATH**/ ?>