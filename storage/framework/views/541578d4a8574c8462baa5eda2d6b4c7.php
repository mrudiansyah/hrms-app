...
<?php $__currentLoopData = $tb_salary_summary_employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php 
        ...
        $potongan = $dt->ketidakhadiran + $dt->standby_oncall + $dt->pph21 + $dt->jaminan_hari_tua + $dt->jaminan_pensiun + $dt->bpjs_kesehatan + $dt->serikat + $dt->koperasi + $dt->lain_lain + $dt->pph21_kurang_bayar;
    ?>
    <table style="width:100%;" cellspacing="0">
        <tr>
            <td class="bingkai" style="padding:7px;">
                <table style="width:100%;" cellspacing="0">
                    <tr>
                        <td style="width:120px;"><img src="<?php echo e(asset('public/gambar/logosai.png')); ?>" style="width:100%;">
                        </td>
                        <td style="text-align:center;">
                            <b style="font-size:14px;">SLIP GAJI KARYAWAN</b><br>
                            <label>PT SUMMIT ADYAWINSA INDONESIA</label><br>
                            <label>Tahun <?php echo e($thn); ?></label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:center;">
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td
                                        style="text-align:center; padding:0px;border:1px solid #C00;color:#F00;font-size:14px;">
                                        R A H A S I A</td>
                                    <td style="width:15%">&nbsp;</td>
                                </tr>
                            </table>
            ...
            <td class="bingkai">
                <table style="width:100%;">
                    ...
                    <tr>
                        <td>JABATAN</td>
                        <td style="text-align:center;">:</td>
                        <td><?php echo e($dt->nama_jabatan); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td class="bingkai" style="padding:10px 5px;">
                <?php    if ($pendapatan == $dt->pendapatan_bruto) {?>
                <table style="width:100%;">
                    <tr>
                    ...
                    <?php        if ($dt->insentif_pph21 > 0 || $dt->pph21_lebih_bayar > 0) {?>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-left:25px;">5.2. PPh21 JAN <?php echo e($thn); ?> (Lebih Bayar)</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding-right:10px;">
                            <?php        echo number_format($dt->pendapatan_bruto, 0);?></td>
                    </tr>
                    <?php        if ($dt->insentif_pph21 == 0 && $dt->pph21_lebih_bayar == 0) {?>
                    <tr>
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td style="padding-left:15px;">6. Seragam</td>
                        <td style="text-align:center;">:</td>
                        <td>&nbsp;</td>
                        <td style="text-align:right;"><?php        echo number_format($dt->seragam, 0);?></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td style="padding-left:15px;">7. Pants</td>
                        <td style="text-align:center;">:</td>
                        <td>&nbsp;</td>
                        <td style="text-align:right;"><?php        echo number_format($dt->pants, 0);?></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <?php        if ($dt->pph21_kurang_bayar > 0) {?>
                    <tr>
                        <td style="padding-left:15px;">9. PPh21 Tahun <?php            $dulu = $thn - 1;
                echo $dulu;?> (Kurang Bayar)</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding-right:10px;border-bottom:1px solid #000;">
                            <?php        echo number_format($dt->potongan, 0);?></td>
                    </tr>
                    <tr>
                        <td colspan="5">&nbsp;</td>
                    </tr>
            ...
            <td class="bingkai">
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style="text-align:center;width:50%;">Diterima oleh,<br><br><br><br><?php echo e($dt->nama_karyawan); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page_ess\salary_slip_magang.blade.php ENDPATH**/ ?>