            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo e(url('/FPPK/store')); ?>" method="POST" role="form">
                            <?php echo csrf_field(); ?>
                            <div class="box-body">
                                <!-- HEADER -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="registration_number" class="form-control"
                                                ...
                                                value="FPPK-<?php echo e(date('Y')); ?>-<?php echo e(rand(100, 999)); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\recruitment\fppk_create.blade.php ENDPATH**/ ?>