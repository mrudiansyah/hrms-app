						...
						<ul class="treeview-menu">
							...
							<?php if(request()->user()->hasRole('training')): ?>
								...
								echo ' active';?>">
															...
															<ul class="treeview-menu">
																<li><a href="/Training/Actuals/0/0"><i class="fa fa-circle-o"></i> Group</a>
																</li>
																<li><a href="/Training/Personal"><i class="fa fa-circle-o"></i> Employee</a>
																</li>
															</ul>
														</li>
													</ul>
		...
		echo ' active';?>">
			...
			<?php if(request()->user()->hasRole('spl_create') || request()->user()->hasRole('admin_department') || request()->user()->hasRole('spl_approval') || request()->user()->hasRole('spl_verification')): ?>
				...
				if (request()->user()->hasRole('spl_verification')) {?>
										<li><a href="/Admin/Overtime/Verifications/0"><i class="fa fa-check-square"></i>
												Verification</a></li>
										<?php }?>
									</ul>
								</li>
					...
					echo ' active';?>">
									...
									<ul class="treeview-menu">
										...
										<?php }?>
										<?php if (request()->user()->hasRole('admin_department')) {?>
										<li><a href="/Assigment/Realisations/0"><i class="fa  fa-check-square-o"></i>
												Realisation</a></li>
										<?php }
				if (request()->user()->hasRole('spl_verification')) {?>
										<li><a href="/Assigment/Verifications/0"><i class="fa fa-check-square"></i> Verification</a>
										</li>
										<?php }?>
									</ul>
								</li>
