                ...
                <div class="box box-primary" style="background:#FFF;">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            ...
                            <a  class="btn btn-app" href="<?php echo e(route('LegalizeSPLAll')); ?>">
    ...
    $(document).ready(function () {
        ...
        function GetData(){
         table = $("#table2").DataTable({
			...
			ajax: {
				type: 'POST',
				url: "<?php echo e(route('LegalizeSPL.GetDataLegalize')); ?>",
				data: function(d) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/admin/m_overtime/legalizespl_fixed.blade.php ENDPATH**/ ?>