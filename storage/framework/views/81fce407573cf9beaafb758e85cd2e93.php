						...
						<table id="tables" class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($dt->passing_grade); ?>

										<div class="pull-right">
											<a href="/Training/Question/<?php echo e($dt->id); ?>" title="Questions" type="button" class="participant btn btn-primary btn-xs"><i class="fa fa-file-text-o"></i></a>
											<button title="Edit" type="button" class="form btn btn-primary btn-xs" data-idtest="<?php echo e($dt->id); ?>" data-testname="<?php echo e($dt->test_name); ?>" data-minutes="<?php echo e($dt->minutes); ?>" data-passinggrade="<?php echo e($dt->passing_grade); ?>"><i class="fa fa-edit"></i></button>
											<button title="Delete" type="button" class="delete-modal btn btn-danger btn-xs" data-delid="<?php echo e($dt->id); ?>" data-delname="<?php echo e($dt->test_name); ?>"><i class="fa fa-trash"></i></button>
										</div>
									</td>
								</tr>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views/page/training/training_test.blade.php ENDPATH**/ ?>