                                        ...
                                        <div class="org-tree-chart">
                                            <ul>
                                                @foreach($tree as $rootNode)
                                                    @include('page.admin.structure.node', ['node' => $rootNode, 'level' => 1])
                                                @endforeach
                                            </ul>
                                        </div>
                                    @else
                ...
                <div class="modal-body" style="padding: 25px;">
                    ...
                    <div id="modal-content-body" style="display: none;">
                        <div class="text-center">
                            <img id="modal-emp-photo" src="{{ asset('/assets/dist/img/user.jpg') }}" class="modal-photo-img"
                                alt="Foto Karyawan">
                    ...
                    success: function (res) {
                        if (res.status === 'success') {
                            ...
                            if (d.photo) {
                                ...
                                $('#modal-emp-photo').attr('src', '{{ asset("/assets/dist/img/user.jpg") }}');
                            }
