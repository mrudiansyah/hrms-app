						...
						<div class="box-body" style="min-height:200px;overflow-x:scroll;">
							<div id="tabel2">
								<table id="table2" class="table table-striped" border="0">
									...
									<?php $no=0;?>
										...
										?>
										<tr>
											<td title="<?php echo e($date_limit); ?>"><?php $no++;echo $no;?></td>
											...
											<td>
												...
												<div class="pull-right">
													...
													<?php if($status_limit==0): ?>
														<button title="Approve" type="button" class="approve-modal btn btn-success btn-xs" data-approveid="<?php echo e($dt->id); ?>" data-approvename="<?php echo e($dt->employee_name); ?>"><i class="fa fa-check-square-o"></i></button>
							...
							<div id="tabel3">
								<table id="table3" class="table table-striped" border="0">
									...
									<tbody>
									<?php $no=0;?>
										<?php $__currentLoopData = $tb_permit_approve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
							...
							<div id="tabel4">
								<table id="table4" class="table table-striped" border="0">
									...
									<tbody>
									<?php $no=0;?>
										<?php $__currentLoopData = $tb_permit_refuse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											<td><?php $no++;echo $no;?></td>
											<td><?php echo e($dt->doc_date); ?></td>
											<td><?php echo ucfirst($dt->category);?></td>
...
<?php echo $__env->make('layouts/admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\.gemini\antigravity-ide\scratch\hrms-app\resources\views\page\admin\m_permit\permit_approve.blade.php ENDPATH**/ ?>